...
#include "unused/npapi.h"
#include "unused/npupp.h"
#include "unused/npruntime.h"
...
static NPError nevv(NPMIMEType pluginType, NPP instance, uint16_t mode, int16 argc, char *argn[], char *argv[], NPSavedData *saved) {
