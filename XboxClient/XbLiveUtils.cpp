...
#define NTDDI_VERSION 0x0A000006 // Windows 10 RS1
#endif
...
RBX::AwardResult xboxEvents_send( Microsoft::Xbox::Services::XboxLiveContext^ xboxLiveContext, const char* evtName, double *value)
{
