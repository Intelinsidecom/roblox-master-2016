...
namespace Roblox.Caching
{
	public abstract class RobloxCache : IRobloxCacheListener
	{
		...
		public abstract IEnumerable<ValueTuple<TIndex, TEntity, bool>> TryGetEntitiesOnlyFromCache<TIndex, TEntity>(ICacheInfo cacheInfo, IReadOnlyCollection<TIndex> entityIds) where TEntity : class, ICacheableObject<TIndex>;
