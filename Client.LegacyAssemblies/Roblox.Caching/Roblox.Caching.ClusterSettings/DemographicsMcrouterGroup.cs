...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class DemographicsMcrouterGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		...
		private static DemographicsMcrouterGroup defaultInstance = (DemographicsMcrouterGroup)SettingsBase.Synchronized(new ThumbnailsMcrouterGroup());
		...
		public static DemographicsMcrouterGroup Default
		{
			get
			{
