...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class PresenceServiceCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static PresenceServiceCacheGroup defaultInstance = (PresenceServiceCacheGroup)SettingsBase.Synchronized(new PresenceServiceCacheGroup());
		...
		public static PresenceServiceCacheGroup Default
		{
			get
			{
