...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class UniversesClientReadMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static UniversesClientReadMcrouterCacheGroup defaultInstance = (UniversesClientReadMcrouterCacheGroup)SettingsBase.Synchronized(new UniversesClientReadMcrouterCacheGroup());
		...
		public static UniversesClientReadMcrouterCacheGroup Default
		{
			get
			{
		...
		internal UniversesClientReadMcrouterCacheGroup()
		{
