...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class FriendsMcrouterGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		...
		private static FriendsMcrouterGroup defaultInstance = (FriendsMcrouterGroup)SettingsBase.Synchronized(new FriendsMcrouterGroup());
		...
		public static FriendsMcrouterGroup Default
		{
			get
			{
