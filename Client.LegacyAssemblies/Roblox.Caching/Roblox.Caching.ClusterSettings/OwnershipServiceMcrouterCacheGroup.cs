...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class OwnershipServiceMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static OwnershipServiceMcrouterCacheGroup defaultInstance = (OwnershipServiceMcrouterCacheGroup)SettingsBase.Synchronized(new OwnershipServiceMcrouterCacheGroup());
		...
		public static OwnershipServiceMcrouterCacheGroup Default
		{
			get
			{
		...
		internal OwnershipServiceMcrouterCacheGroup()
		{
