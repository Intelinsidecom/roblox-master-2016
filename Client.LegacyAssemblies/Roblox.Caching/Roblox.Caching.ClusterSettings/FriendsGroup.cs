...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class FriendsGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static FriendsGroup defaultInstance = (FriendsGroup)SettingsBase.Synchronized(new FriendsGroup());
		...
		public static FriendsGroup Default
		{
			get
			{
