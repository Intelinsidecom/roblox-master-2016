...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class UserMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static UserMcrouterCacheGroup defaultInstance = (UserMcrouterCacheGroup)SettingsBase.Synchronized(new UserMcrouterCacheGroup());
		...
		public static UserMcrouterCacheGroup Default
		{
			get
			{
		...
		internal UserMcrouterCacheGroup()
		{
