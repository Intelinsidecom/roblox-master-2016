...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class UniversesServiceCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static UniversesServiceCacheGroup defaultInstance = (UniversesServiceCacheGroup)SettingsBase.Synchronized(new UniversesServiceCacheGroup());
		...
		public static UniversesServiceCacheGroup Default
		{
			get
			{
		...
		internal UniversesServiceCacheGroup()
		{
