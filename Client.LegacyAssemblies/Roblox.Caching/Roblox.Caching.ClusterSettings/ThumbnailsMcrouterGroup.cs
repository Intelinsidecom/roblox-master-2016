...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class ThumbnailsMcrouterGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static ThumbnailsMcrouterGroup defaultInstance = (ThumbnailsMcrouterGroup)SettingsBase.Synchronized(new ThumbnailsMcrouterGroup());
		...
		public static ThumbnailsMcrouterGroup Default
		{
			get
			{
		...
		internal ThumbnailsMcrouterGroup()
		{
