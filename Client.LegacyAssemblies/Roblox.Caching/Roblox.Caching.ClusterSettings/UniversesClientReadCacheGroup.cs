...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class UniversesClientReadCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static UniversesClientReadCacheGroup defaultInstance = (UniversesClientReadCacheGroup)SettingsBase.Synchronized(new UniversesClientReadCacheGroup());
		...
		public static UniversesClientReadCacheGroup Default
		{
			get
			{
		...
		internal UniversesClientReadCacheGroup()
		{
