...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class GroupsServiceMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static GroupsServiceMcrouterCacheGroup defaultInstance = (GroupsServiceMcrouterCacheGroup)SettingsBase.Synchronized(new GroupsServiceMcrouterCacheGroup());
		...
		public static GroupsServiceMcrouterCacheGroup Default
		{
			get
			{
		...
		internal GroupsServiceMcrouterCacheGroup()
		{
