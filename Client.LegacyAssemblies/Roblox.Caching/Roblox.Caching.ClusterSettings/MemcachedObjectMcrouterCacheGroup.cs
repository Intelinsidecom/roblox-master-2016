...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class MemcachedObjectMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static MemcachedObjectMcrouterCacheGroup defaultInstance = (MemcachedObjectMcrouterCacheGroup)SettingsBase.Synchronized(new MemcachedObjectMcrouterCacheGroup());
		...
		public static MemcachedObjectMcrouterCacheGroup Default
		{
			get
			{
		...
		internal MemcachedObjectMcrouterCacheGroup()
		{
