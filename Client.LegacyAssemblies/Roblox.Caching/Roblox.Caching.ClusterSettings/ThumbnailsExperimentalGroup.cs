...
namespace Roblox.Caching.ClusterSettings
{
	...
	internal sealed class ThumbnailsExperimentalGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
	{
		private readonly ConcurrentDictionary<string, object> _Properties = new ConcurrentDictionary<string, object>();

		private static ThumbnailsExperimentalGroup defaultInstance = (ThumbnailsExperimentalGroup)SettingsBase.Synchronized(new ThumbnailsExperimentalGroup());
		...
		public static ThumbnailsExperimentalGroup Default
		{
			get
			{
		...
		internal ThumbnailsExperimentalGroup()
		{
