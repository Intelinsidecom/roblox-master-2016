...
namespace Roblox.Platform.Infrastructure
{
	public class DatacenterGroupFactory
	{
		...
		{
			return InfrastructureCache.FetchItem("AllDatacenterGroups", _GroupListCacheDuration, () => ((RobloxDatabase)94).ExecuteReader("DataCenterGroups_GetAllDataCenterGroups", (SqlParameter[])null, CommandType.StoredProcedure, (int?)null, (ApplicationIntent?)null).Select(BuildDatacenterGroup).ToArray());
		}
