...
namespace Roblox.MssqlDatabases
{
	public static class Extensions
	{
		...
		private static readonly Type _SettingsType = _Settings.GetType();
		...
		public static int ExecuteNonQuery(this RobloxDatabase robloxDatabase, string commandText, SqlParameter[] sqlParameters, CommandType commandType = CommandType.StoredProcedure, int? commandTimeout = null, ApplicationIntent? applicationIntent = null)
		{
		...
		public static Task<int> ExecuteNonQueryAsync(this RobloxDatabase robloxDatabase, string commandText, SqlParameter[] sqlParameters, CommandType commandType = CommandType.StoredProcedure, CancellationToken cancellationToken = default(CancellationToken), int? commandTimeout = null, ApplicationIntent? applicationIntent = null)
		{
		...
		public static IEnumerable<IDictionary<string, object>> ExecuteReader(this RobloxDatabase robloxDatabase, string commandText, SqlParameter[] sqlParameters, CommandType commandType = CommandType.StoredProcedure, int? commandTimeout = null, ApplicationIntent? applicationIntent = null)
		{
		...
		public static object ExecuteScalar(this RobloxDatabase robloxDatabase, string commandText, SqlParameter[] sqlParameters, CommandType commandType = CommandType.StoredProcedure, int? commandTimeout = null, ApplicationIntent? applicationIntent = null)
		{
		...
		public static Task<object> ExecuteScalarAsync(this RobloxDatabase robloxDatabase, string commandText, SqlParameter[] sqlParameters, CommandType commandType = CommandType.StoredProcedure, CancellationToken cancellationToken = default(CancellationToken), int? commandTimeout = null, ApplicationIntent? applicationIntent = null)
		{
		...
		private static IDatabaseObserver BuildDatabaseObserver(IDatabase database)
		{
			...
			return (IDatabaseObserver)new DatabaseObserver(database, StaticCounterRegistry.Instance);
		}
	}
}
