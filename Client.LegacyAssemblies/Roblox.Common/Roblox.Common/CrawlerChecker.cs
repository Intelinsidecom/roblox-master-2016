...
namespace Roblox.Common
{
	public class CrawlerChecker
	{
		...
		public static string CrawlerUserAgentRegexString
		{
			get
			{
				return Settings.Default.CrawlerUserAgentRegex;
			}
		}

		public static bool ReuseCrawlerUserAgentRegex
		{
			get
			{
				return Settings.Default.ReuseCrawlerUserAgentRegex;
			}
		}
