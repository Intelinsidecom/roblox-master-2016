 ...
 * ============================================================
 * Address     : 00402ff6
 * Raw Name    : get_NameFilter
 * Demangled   : get_NameFilter
 * Prototype   : char * get_NameFilter(undefined4 param_1, byte * param_2)
 * Local Vars  : param_1, param_2, pcStack_20, bVar1, bVar2, cVar3, in_EAX, pcVar4, pbVar5, piVar6, uVar7, uVar8, uVar9, bVar10, uVar11, cVar12, uVar13, cVar14, unaff_EBX, pcVar15, cVar16, uVar17, unaff_ESI, in_ES, in_DS
 */
...
char * __fastcall get_NameFilter(undefined4 param_1,byte *param_2)

{
  ...
  cVar16 = (char)((uint)unaff_EBX >> 8) + *(char *)(unaff_EBX + 0x22);
...
code_r0x00403072:
    ...
    *(char *)CONCAT31(uVar7,bVar1) = *(char *)CONCAT31(uVar7,bVar1) + bVar1;
    pcStack_20 = (char *)CONCAT22(pcStack_20._2_2_,in_DS);
...
code_r0x0040309a:
  ...
  *pbVar5 = *pbVar5 + cVar16;
  ...
  unaff_ESI[0x20a0000] = unaff_ESI[0x20a0000] - cVar12;
  *pcVar4 = *pcVar4 + cVar3;
  cVar14 = (char)pcStack_20 - *unaff_ESI;
  pcVar15 = (char *)CONCAT22((short)((uint)pcStack_20 >> 0x10),
                             CONCAT11((char)((uint)pcStack_20 >> 8) +
                                      *(char *)(CONCAT31((int3)((uint)pcStack_20 >> 8),cVar14) +
                                               0x34),cVar14));
  *pcVar4 = *pcVar4 + cVar3;
  bVar1 = cVar16 + 0x54U & *param_2;
  *(char *)CONCAT31(uVar7,bVar1) = *(char *)CONCAT31(uVar7,bVar1) + bVar1;
