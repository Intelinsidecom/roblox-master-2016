...
void __fastcall set_TotalPageCount(undefined4 value,uint *param_2)

{
  ...
  if (SCARRY1(bVar7,(byte)*unaff_EBX) == cVar6 < '\0') {
...
code_r0x00402898:
    ...
    *pbVar10 = *pbVar10 + (char)pbVar10;
    ...
    do {
      ...
      *pbVar10 = *pbVar10 + bVar27;
      *pbVar10 = *pbVar10 | bVar27;
      bVar44 = CARRY1((byte)*puVar20,bVar7);
      *(byte *)puVar20 = (byte)*puVar20 + bVar7;
      cVar6 = bVar27 + 10 + bVar44;
      pbVar10 = (byte *)CONCAT31((int3)((uint)pbVar10 >> 8),cVar6);
      puVar14 = unaff_ESI;
    } while (bVar27 < 0xf6 && !CARRY1(bVar27 + 10,bVar44));
    *pbVar10 = *pbVar10 + cVar6;
...
code_r0x00402974:
      ...
      *piVar21 = (int)((int)unaff_ESI + (uint)bVar7 + *piVar21);
      bVar44 = SCARRY4(*puVar20,(int)puVar20);
...
code_r0x00402995:
        ...
        ;
        bVar7 = (byte)puVar14;
        bVar44 = CARRY1(bVar7,(byte)*puVar14);
            ...
            *puVar14 = (uint)(*puVar14 + (int)puVar14);
            if (SCARRY4(uVar1,(int)puVar14)) {
              ...
              *(byte *)unaff_EDI = (byte)*unaff_EDI - (char)unaff_EBX;
              ...
              bVar44 = CARRY1(bVar27,(byte)*puVar14);
...
code_r0x004029c4:
            ...
            bVar7 = (byte)puVar20;
            bVar44 = CARRY1((byte)*param_2,bVar7);
...
code_r0x004029c6:
    ...
    bVar44 = CARRY1(*pbVar10,bVar27);
    *pbVar10 = *pbVar10 + bVar27;
  } while( true );
code_r0x00402992:
  pbVar10 = (byte *)((int)puVar14 + 0x2a);
  bVar44 = CARRY1(*pbVar10,bVar35);
  *pbVar10 = *pbVar10 + bVar35;
...
code_r0x00402a7f:
  ...
  *(byte *)puVar20 = (byte)*puVar20 + (char)param_2;
  puVar39 = (uint *)((int)puVar39 + (((uint)bVar45 * -8 + 4) - iVar17));
...
code_r0x00402bd1:
              uVar12 = *unaff_EBX;
              uVar1 = *unaff_EBX;
              *unaff_EBX = (uint)((byte *)(uVar1 + (int)puVar20) + bVar44);
              bVar7 = POPCOUNT(*unaff_EBX & 0xff);
              uVar42 = in_SS;
              if ((SCARRY4(uVar12,(int)puVar20) != SCARRY4((int)(uVar1 + (int)puVar20),(uint)bVar44)
...
code_r0x00402bdb:
                ...
                *pcVar37 = *pcVar37 + cVar6;
                ...
                do {
                  ...
                  puVar20 = (uint *)CONCAT31((int3)((uint)puVar20 >> 8),bVar7 + bVar44);
...
code_r0x00402dff:
  ...
  puVar23 = puVar14 + (uint)bVar45 * -2 + 1;
...
code_r0x00402e5a:
  *pbVar22 = *pbVar22 + (char)pbVar22;
  ...
  puVar14 = puVar23 + (uint)bVar45 * -2 + 1;
      ...
      while( true ) {
        ...
        *(byte *)puVar39 = (byte)*puVar39 + cVar9;
        ...
        if (!SCARRY4((int)puVar40,*puVar40)) {
          bVar44 = CARRY4((uint)unaff_EBP,*puVar23);
          unaff_EBP = unaff_EBP + *puVar23;
        }
        *puVar23 = (*puVar23 - (int)puVar23) - (uint)bVar44;
        *(byte *)puVar39 = (byte)*puVar39 + cVar9;
        puVar20 = (uint *)CONCAT22((short)((uint)puVar20 >> 0x10),
...
code_r0x00402f3b:
        ...
        *pbVar15 = *pbVar15 + bVar30;
        ...
        bVar29 = (byte)puVar20;
        *(byte *)puVar14 = (byte)*puVar14 + cVar6;
        puVar20 = puVar14 + (uint)bVar45 * -2 + 1;
        out(*puVar14,(short)puVar39);
        *(byte *)puVar20 = (byte)*puVar20 + cVar6;
        bVar27 = *pbVar15;
        *(byte *)puVar39 = (byte)*puVar39 - bVar38;
        *(byte *)puVar20 = (byte)*puVar20 + cVar6;
        puVar40 = puVar20 + (uint)bVar45 * -2 + 1;
...
code_r0x004030df:
        ...
        puVar14 = puVar40 + (uint)bVar45 * -2 + 1;
        out(*puVar40,uVar34);
        pcVar37 = unaff_EBP + 1;
      ...
      *pbVar10 = *pbVar10 + bVar7;
code_r0x00402ef9:
      pcVar37 = (char *)CONCAT31(uVar25,bVar7 - bVar44);
      pbVar10 = (byte *)((int)puVar41 + (int)unaff_EBP * 2);
      *pbVar10 = *pbVar10 + (bVar7 - bVar44);
    }
  } while( true );
code_r0x00402e36:
  *(byte *)puVar20 = (byte)*puVar20 + (char)puVar39;
  ...
  bVar7 = (byte)puVar20;
  bVar44 = (byte)*puVar23 < bVar7;
  *(byte *)puVar23 = (byte)*puVar23 - bVar7;
  bVar7 = (byte)pbVar10 + *pbVar10;
  piVar21 = (int *)CONCAT31((int3)((uint)pbVar10 >> 8),bVar7 + bVar44);
  puVar23 = puVar41;
  uVar42 = in_ES;
  if (CARRY1((byte)pbVar10,*pbVar10) || CARRY1(bVar7,bVar44)) goto code_r0x00402dff;
