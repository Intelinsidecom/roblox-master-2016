 ...
 * ============================================================
 * Address     : 00402fed
 * Raw Name    : set_GroupFilter
 * Demangled   : set_GroupFilter
 * Prototype   : void set_GroupFilter(undefined4 value, byte * param_2)
 * Local Vars  : pcStack_18, cVar1, bVar2, bVar3, cVar4, param_2, in_EAX, pcVar5, value, pbVar6, piVar7, uVar8, bVar9, cVar10, unaff_EBX, pcVar11, cVar12, uVar13, unaff_ESI, in_ES, in_DS
 */
...
void __fastcall set_GroupFilter(undefined4 value,byte *param_2)

{
  ...
  if (SCARRY1((char)in_EAX,*unaff_EBX) != cVar1 < '\0') {
    *pcVar5 = *pcVar5 + cVar1;
    ...
    cVar12 = (char)((uint)unaff_EBX >> 8) + unaff_EBX[0x22];
    *pcVar5 = *pcVar5 + cVar1 + '*';
    ...
    *(char *)CONCAT31(uVar8,bVar2) = *(char *)CONCAT31(uVar8,bVar2) + bVar2;
    ...
    unaff_EBX = (char *)CONCAT22(uVar13,CONCAT11(cVar12 + *(char *)(CONCAT22(uVar13,CONCAT11(cVar12,
                                                  (char)unaff_EBX)) + 0x25),(char)unaff_EBX));
  }
  ...
  *(char *)CONCAT31(uVar8,bVar2) = *(char *)CONCAT31(uVar8,bVar2) + bVar2;
  ...
  pcVar11 = (char *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
                             CONCAT11((char)((uint)unaff_EBX >> 8) + unaff_EBX[0x26],(char)unaff_EBX
                                     ));
  ...
  *(char *)CONCAT31(uVar8,bVar2) = *(char *)CONCAT31(uVar8,bVar2) + bVar2;
  ...
  if ((POPCOUNT(cVar1) & 1U) == 0) {
    ...
    *pbVar6 = *pbVar6 + bVar3;
    ...
    uVar13 = (undefined2)((uint)value >> 0x10);
    if (!CARRY1(bVar2,bVar3)) {
      if (!SCARRY1(bVar3,'\0')) {
        *pbVar6 = *pbVar6 + bVar3;
        value = CONCAT22(uVar13,CONCAT11(bVar9 | *param_2,(char)value));
        bVar3 = bVar3 & *param_2;
        *(char *)CONCAT31(uVar8,bVar3) = *(char *)CONCAT31(uVar8,bVar3) + bVar3;
        pcVar5 = (char *)CONCAT31(uVar8,bVar3 + 0x2a);
        goto code_r0x00403058;
      }
      pcVar5 = (char *)CONCAT31(uVar8,bVar3 + *pcVar11);
      if (SCARRY1(bVar3,*pcVar11) != (char)(bVar3 + *pcVar11) < '\0') goto code_r0x00403072;
      goto code_r0x0040309a;
    }
    bVar2 = bVar3 + *pcVar11;
    pbVar6 = (byte *)CONCAT31(uVar8,bVar2);
    if (SCARRY1(bVar3,*pcVar11) == (char)bVar2 < '\0') {
      pcVar5 = (char *)CONCAT22(uVar13,CONCAT11(bVar9 | *param_2,(char)value));
...
code_r0x004030df:
  *pcVar5 = *pcVar5 + cVar12;
  ...
  bVar3 = (byte)pbVar6;
  *pbVar6 = *pbVar6 + bVar3;
  *(byte **)(pcVar11 + -0x41) = unaff_ESI + (uint)CARRY1(bVar2,bVar3) + *(int *)(pcVar11 + -0x41);
  *pbVar6 = *pbVar6 + bVar3;
  uVar8 = (undefined3)((uint)pbVar6 >> 8);
