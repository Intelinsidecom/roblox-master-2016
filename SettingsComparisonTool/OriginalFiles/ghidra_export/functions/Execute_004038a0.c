 ...
 * Local Vars  : pbStack_14, pbStack_10, pcVar1, uVar2, uVar3, bVar4, cVar5, cVar6, bVar7, bVar8, in_EAX, piVar9, pbVar10, pbVar11, pcVar12, pcVar13, pbVar14, puVar15, uVar16, uVar17, uVar18, extraout_ECX, bVar19, uVar20, puVar21, uVar22, cVar23, uVar24, unaff_EBX, bVar25, unaff_EBP, unaff_ESI, unaff_EDI, in_ES, in_CS, param_1, bVar26, param_2, uVar27, unaff_retaddr
 */
        ...
        if (CARRY1(bVar4,bVar7)) {
          *pbVar11 = *pbVar11 + cVar5;
          param_1 = (byte *)CONCAT22((short)((uint)param_1 >> 0x10),
                                     CONCAT11(bVar7 | *pbVar11,(char)param_1));
...
code_r0x00403950:
    ...
    *unaff_EBX = *unaff_EBX + bVar7;
    if (!CARRY1(bVar4,bVar7)) {
      ...
      *param_2 = *param_2 + (char)param_1;
      bVar7 = bVar4 - *(byte *)CONCAT31(uVar16,bVar4);
      unaff_ESI = unaff_ESI +
                  ((4 - *(int *)CONCAT31(uVar16,bVar7)) -
                  (uint)(bVar4 < *(byte *)CONCAT31(uVar16,bVar4)));
      pbVar11 = (byte *)CONCAT31(uVar16,bVar7);
      bVar4 = *pbVar11;
      *pbVar11 = *pbVar11 + bVar7;
      in_EAX = CONCAT31(uVar16,(bVar7 - *pbVar11) - CARRY1(bVar4,bVar7));
      *param_1 = *param_1 + (char)param_2;
      goto code_r0x004038a0;
    }
    ...
    *(byte **)(unaff_ESI + (int)unaff_EDI * 8) =
         param_1 + (uint)(0xd2 < bVar4) + *(int *)(unaff_ESI + (int)unaff_EDI * 8);
...
code_r0x00403979:
  ...
  pbVar11 = (byte *)CONCAT31((int3)((uint)pbVar10 >> 8),bVar4 - *param_1);
  do {
    cVar5 = (char)pbVar11;
    ...
    *(byte **)unaff_ESI = unaff_EBX + *(int *)unaff_ESI;
    ...
    param_1 = (byte *)CONCAT22((short)((uint)param_1 >> 0x10),
                               CONCAT11(bVar4 + *pbVar11,(char)param_1));
...
code_r0x00403991:
    ...
    *(byte *)piVar9 = (char)*piVar9 + bVar4;
    param_1 = (byte *)CONCAT22((short)((uint)param_1 >> 0x10),CONCAT11(bVar7 | *param_2,cVar5));
...
code_r0x004039c8:
  ...
  *pbVar10 = *pbVar10 + (char)uVar2;
  bVar19 = (byte)((uint)param_1 >> 8) | *pbVar10;
    ...
    *pcVar13 = *pcVar13 + cVar5;
    ...
    if ((POPCOUNT(bVar4) & 1U) == 0) {
      ...
      *pbVar11 = *pbVar11 + bVar19;
      ...
      pbVar11 = (byte *)CONCAT31(uVar16,bVar19);
      param_1 = (byte *)(CONCAT22((short)((uint)param_1 >> 0x10),
                                  CONCAT11((byte)((uint)param_1 >> 8) | bVar7,bVar8)) + -1);
      bVar4 = *pbVar11;
      *pbVar11 = *pbVar11 + bVar19;
...
code_r0x00403a8f:
  ...
  param_1 = (byte *)CONCAT22((short)((uint)param_1 >> 0x10),
                             CONCAT11((byte)((uint)param_1 >> 8) | *pbVar10,(char)param_1));
    ...
    *param_1 = *param_1 + bVar4;
    ...
    while( true ) {
      ...
      *(byte **)pbStack_14 = unaff_EBX + *(int *)pbStack_14;
      bVar4 = (byte)((uint)param_1 >> 8);
      cVar5 = (char)param_1;
      param_1 = (byte *)CONCAT22((short)((uint)param_1 >> 0x10),CONCAT11(bVar4 + *pbVar10,cVar5));
...
code_r0x00403b73:
        ...
        *unaff_EBX = *unaff_EBX + bVar19;
        ...
        pcVar13 = (char *)CONCAT22((short)((uint)param_1 >> 0x10),CONCAT11(bVar19,cVar5));
