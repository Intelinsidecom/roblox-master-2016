 ...
 * Local Vars  : uStack_c, bVar1, cVar2, cVar3, in_EAX, param_1, pcVar4, param_2, pbVar5, piVar6, uVar7, bVar8, cVar9, cVar10, unaff_ESI, pbVar11, in_ES, in_DS
 */
...

{
  ...
  *pcVar4 = *pcVar4 + bVar1 + 0x2a;
  bVar1 = bVar1 + 0x54 & *param_2;
  *(char *)CONCAT31(uVar7,bVar1) = *(char *)CONCAT31(uVar7,bVar1) + bVar1;
  uStack_c = (char *)CONCAT22(uStack_c._2_2_,in_DS);
  pcVar4 = uStack_c;
  bVar8 = (char)((uint)param_1 >> 8) + *(char *)CONCAT31(uVar7,bVar1 + 0x2a);
  cVar9 = (char)param_2;
  unaff_ESI[0x20a0000] = unaff_ESI[0x20a0000] - cVar9;
  cVar2 = (char)in_DS;
  *uStack_c = *uStack_c + cVar2;
  uStack_c = (char *)CONCAT22(uStack_c._2_2_,in_ES);
  *pcVar4 = *pcVar4 + cVar2;
  ...
  *pcVar4 = *pcVar4 + cVar3;
  ...
  cVar2 = *(char *)(CONCAT31((int3)((uint)uStack_c >> 8),cVar10) + 0x34);
  *pcVar4 = *pcVar4 + cVar3;
  bVar1 = bVar1 + 0x54 & *param_2;
  *(char *)CONCAT31(uVar7,bVar1) = *(char *)CONCAT31(uVar7,bVar1) + bVar1;
  ...
  *pcVar4 = *pcVar4 + cVar9;
  bVar1 = *pbVar5;
  *pbVar5 = *pbVar5 + bVar8;
  piVar6 = (int *)(CONCAT22(uStack_c._2_2_,CONCAT11((char)((ushort)in_ES >> 8) + cVar2,cVar10)) +
                  -0x41);
