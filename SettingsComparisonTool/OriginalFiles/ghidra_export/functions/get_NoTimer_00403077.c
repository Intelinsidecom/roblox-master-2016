 ...
 * ============================================================
 * Address     : 00403077
 * Raw Name    : get_NoTimer
 * Demangled   : get_NoTimer
 * Prototype   : bool get_NoTimer(undefined4 param_1, byte * param_2)
 * Local Vars  : param_1, param_2, uStack_4, bVar1, cVar2, cVar3, in_EAX, pcVar4, pbVar5, piVar6, uVar7, bVar8, cVar9, cVar10, unaff_ESI, pbVar11, in_ES, in_DS
 */
...
bool __fastcall get_NoTimer(undefined4 param_1,byte *param_2)

{
  ...
  *in_EAX = *in_EAX + (char)in_EAX;
  ...
  pcVar4 = (char *)CONCAT31(uVar7,bVar1);
  *pcVar4 = *pcVar4 + bVar1;
  uStack_4 = (char *)CONCAT22(uStack_4._2_2_,in_DS);
  pcVar4 = uStack_4;
  bVar8 = (char)((uint)param_1 >> 8) + *(char *)CONCAT31(uVar7,bVar1 + 0x2a);
  cVar9 = (char)param_2;
  unaff_ESI[0x20a0000] = unaff_ESI[0x20a0000] - cVar9;
  cVar2 = (char)in_DS;
  *uStack_4 = *uStack_4 + cVar2;
  uStack_4 = (char *)CONCAT22(uStack_4._2_2_,in_ES);
  *pcVar4 = *pcVar4 + cVar2;
  ...
  *pcVar4 = *pcVar4 + cVar3;
  ...
  cVar2 = *(char *)(CONCAT31((int3)((uint)uStack_4 >> 8),cVar10) + 0x34);
  *pcVar4 = *pcVar4 + cVar3;
  ...
  *pcVar4 = *pcVar4 + cVar9;
  bVar1 = *pbVar5;
  *pbVar5 = *pbVar5 + bVar8;
  piVar6 = (int *)(CONCAT22(uStack_4._2_2_,CONCAT11((char)((ushort)in_ES >> 8) + cVar2,cVar10)) +
                  -0x41);
