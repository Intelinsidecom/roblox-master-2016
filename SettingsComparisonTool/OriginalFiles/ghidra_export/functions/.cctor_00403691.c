 ...
 * Raw Name    : .cctor
 * Demangled   : .cctor
 * Prototype   : byte * .cctor(char * param_1, int * param_2)
 * Local Vars  : uVar26, puVar27, cVar28, uVar29, unaff_EBX, pbVar30, bVar31, cVar32, bVar33, uVar34, puVar35, puVar36, piVar37, piVar38, puVar39, puVar40, puVar41, puVar42, puVar43, puVar44, puVar45, puVar46, puVar47, puVar48, puVar49, puVar50, puVar51, puVar52, puVar53, puVar54, unaff_EBP, pbVar55, unaff_ESI, pbVar56, pbVar57, unaff_EDI, puVar58, in_ES, in_CS, in_SS, uVar59, in_DS, uVar60, in_CF, bVar61, in_AF, in_TF, in_IF, bVar62, in_NT, in_AC, in_VIF, in_VIP, in_ID, uVar63, unaff_retaddr, param_1, param_2, puStack_4, puVar1, uVar2, uVar3, pcVar4, uVar5, iVar6, puVar7, bVar8, cVar9, bVar10, cVar11, bVar12, bVar13, bVar14, in_EAX, pbVar15, pcVar16, piVar17, pbVar18, pbVar19, pcVar20, pbVar21, puVar22, uVar23, uVar24, iVar25, extraout_ECX, extraout_ECX_00
 */
...
byte * __fastcall _cctor(char *param_1,int *param_2)

{
  ...
  pcVar20 = param_1;
  if (!in_CF) goto code_r0x004036a6;
  *in_EAX = *in_EAX + (byte)in_EAX;
  in_EAX = (char *)CONCAT31((int3)((uint)in_EAX >> 8),(byte)in_EAX | in_EAX[0x400003f]);
  pcVar20 = (char *)CONCAT31((int3)((uint)param_1 >> 8),
                             (char)param_1 - *(char *)((int)param_2 + 0x5040302));
  *(char *)((int)in_EAX * 2) = *(char *)((int)in_EAX * 2) - (char)((uint)param_1 >> 8);
  while( true ) {
    unaff_retaddr = in_ES;
code_r0x004036a6:
    pcVar20 = (char *)CONCAT31((int3)((uint)pcVar20 >> 8),(char)pcVar20 + *unaff_ESI);
    pbVar15 = (byte *)(CONCAT31((int3)((uint)in_EAX >> 8),(char)in_EAX + '%') + 0x1ebd9f3);
    puStack_4 = (undefined4 *)CONCAT22(puStack_4._2_2_,in_ES);
    bVar8 = (byte)pbVar15;
    bVar61 = CARRY1(*pbVar15,bVar8);
    *pbVar15 = *pbVar15 + bVar8;
    puVar35 = puStack_4 + -1;
    *(undefined2 *)(puStack_4 + -1) = in_ES;
    cVar11 = (char)param_2;
    if (bVar61) {
      *pbVar15 = *pbVar15 + bVar8;
      uVar59 = (undefined2)((uint)unaff_EBX >> 0x10);
      bVar31 = (byte)((uint)unaff_EBX >> 8) | unaff_EBP[0x47];
      pcVar16 = (char *)CONCAT22(uVar59,CONCAT11(bVar31,(char)unaff_EBX));
      *pbVar15 = *pbVar15 + bVar8;
      ...
      *pcVar20 = *pcVar20 + cVar11;
      unaff_EBX = (byte *)CONCAT22(uVar59,CONCAT11(bVar31 + pcVar16[0x38],(char)unaff_EBX));
      *pbVar15 = *pbVar15 + bVar8;
      cVar9 = bVar8 + 2;
      ...
      *(char *)CONCAT31(uVar23,cVar9) = *(char *)CONCAT31(uVar23,cVar9) + cVar9;
      bVar8 = bVar8 + 0x71;
      pbVar15 = (byte *)CONCAT31(uVar23,bVar8);
      in_SS = *(undefined2 *)(puStack_4 + -1);
      *pbVar15 = *pbVar15 + bVar8;
      iVar25 = (int)pcVar20 - *param_2;
      pcVar20 = (char *)CONCAT22((short)((uint)iVar25 >> 0x10),
                                 CONCAT11((char)((uint)iVar25 >> 8) + *pbVar15,(char)iVar25));
      unaff_EBP = (char *)*puStack_4;
      bVar61 = CARRY1(*pbVar15,bVar8);
      *pbVar15 = *pbVar15 + bVar8;
      *(undefined2 *)puStack_4 = in_ES;
      *(undefined2 *)(puStack_4 + -1) = in_ES;
    }
    bVar8 = (byte)pbVar15;
    uVar23 = (undefined3)((uint)pbVar15 >> 8);
    if (bVar61) break;
    *(byte *)param_2 = (char)*param_2 + (byte)pcVar20;
    *(char *)((int)param_2 + (int)unaff_EBP) = *(char *)((int)param_2 + (int)unaff_EBP) + bVar8;
    iVar25 = CONCAT31(uVar23,(char)*param_2);
    in_EAX = (char *)(iVar25 + *(int *)(iVar25 + 0x6c28));
  }
  *pbVar15 = *pbVar15 + bVar8;
  uVar24 = (uint3)((uint)pcVar20 >> 8);
  pbVar57 = (byte *)CONCAT31(uVar24,(byte)pcVar20 | *unaff_EBX);
  in_SS = *(undefined2 *)puStack_4;
  puVar35 = puStack_4 + 1;
  pbVar56 = unaff_ESI + 4;
  ...
  *(byte *)((int)unaff_EDI + 0x6f0a0001) =
       *(byte *)((int)unaff_EDI + 0x6f0a0001) - (char)((uint)pcVar20 >> 8);
  bRam2a060000 = bVar8;
  *(undefined2 *)puStack_4 = unaff_retaddr;
  cVar28 = (char)unaff_EBX;
  cVar9 = cVar28 - (char)*param_2;
  unaff_EBX = (byte *)CONCAT31((int3)((uint)unaff_EBX >> 8),cVar9);
  if (cVar9 == '\0' || cVar28 < (char)*param_2) {
code_r0x00403750:
    uVar63 = CONCAT44(param_2,pbVar15);
    unaff_ESI = pbVar56 + 4;
    out(*(undefined4 *)pbVar56,(short)param_2);
    bVar10 = (byte)pbVar15;
    ...
    *pbVar15 = *pbVar15 + bVar8;
    ...
    cVar9 = (char)((uint)param_2 >> 8) + *(char *)((int)param_2 + -0x7b);
    uVar63 = CONCAT44(CONCAT22((short)((uint)param_2 >> 0x10),CONCAT11(cVar9,cVar11)),iVar25);
    in_ES = *(undefined2 *)puStack_4;
    ...
    do {
      ...
      *(char *)piVar17 = (char)*piVar17;
      if ((char)*piVar17 == '\0') {
        ...
        unaff_retaddr = in_ES;
_ctor:
        param_2 = (int *)((ulonglong)uVar63 >> 0x20);
