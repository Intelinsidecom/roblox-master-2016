 ...
 * ============================================================
 * Address     : 00402fdc
 * Raw Name    : set_OutputFileName
 * Demangled   : set_OutputFileName
 * Prototype   : void set_OutputFileName(undefined4 value, byte * param_2)
 * Local Vars  : pcStack_14, cVar1, bVar2, bVar3, cVar4, value, in_EAX, pcVar5, pbVar6, piVar7, uVar8, bVar9, cVar10, unaff_EBX, cVar11, uVar12, unaff_EBP, unaff_ESI, in_ES, in_DS, param_2
 */
...
void __fastcall set_OutputFileName(undefined4 value,byte *param_2)

{
  ...
  cVar1 = cVar11 + *unaff_EBX;
  pcVar5 = (char *)CONCAT31(uVar8,cVar1);
  if (SCARRY1(cVar11,*unaff_EBX) == cVar1 < '\0') {
    if (SCARRY1(cVar11,*unaff_EBX) != cVar1 < '\0') goto code_r0x00403002;
