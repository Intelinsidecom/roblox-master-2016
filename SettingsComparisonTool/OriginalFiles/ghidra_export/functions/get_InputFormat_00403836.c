 ...
 * Prototype   : byte * get_InputFormat(byte * param_1, byte * param_2)
 * Local Vars  : cVar27, bVar28, unaff_EBP, unaff_ESI, unaff_EDI, in_ES, in_CS, in_DS, bVar29, uVar30, pbStack_2c, param_1, pbStack_28, param_2, pbStack_18, pbStack_8, iVar1, iVar2, pcVar3, uVar4, uVar5, bVar6, bVar7, cVar8, bVar9, bVar10, in_EAX, piVar11, pbVar12, pbVar13, pcVar14, pcVar15, puVar16, uVar17, uVar18, uVar19, extraout_ECX, uVar20, pbVar21, puVar22, uVar23, cVar24, cVar25, uVar26, unaff_EBX
 */
...
byte * __fastcall get_InputFormat(byte *param_1,byte *param_2)
...
code_r0x00403836:
  ...
  cVar27 = (char)((uint)unaff_EBX >> 8) +
           *(char *)(CONCAT31((int3)((uint)unaff_EBX >> 8),cVar24) + 0x57);
...
code_r0x00403916:
      ...
      *(byte **)(pbStack_8 + (int)unaff_EDI * 8) =
           param_2 + (uint)(0xd2 < bVar7) + *(int *)(pbStack_8 + (int)unaff_EDI * 8);
code_r0x00403926:
...
code_r0x00403950:
          ...
          *param_2 = *param_2 + (char)param_1;
          pbVar13 = (byte *)CONCAT31(uVar17,(bVar7 & bVar6) + *pbStack_8);
    ...
    *unaff_EBX = *unaff_EBX + bVar7;
    if (!CARRY1(bVar6,bVar7)) {
      ...
      bVar6 = (cVar27 - (char)*piVar11) - CARRY1(bVar6,bVar7);
      *param_2 = *param_2 + (char)param_1;
      cVar8 = bVar6 - *(byte *)CONCAT31(uVar17,bVar6);
      unaff_ESI = pbStack_8 +
                  ((4 - *(int *)CONCAT31(uVar17,cVar8)) -
                  (uint)(bVar6 < *(byte *)CONCAT31(uVar17,bVar6)));
      in_EAX = (char *)CONCAT31(uVar17,cVar8);
      pbStack_8 = (byte *)0;
      goto code_r0x00403836;
    }
    ...
    *(byte **)(pbStack_8 + (int)unaff_EDI * 8) =
         param_1 + (uint)(0xd2 < bVar6) + *(int *)(pbStack_8 + (int)unaff_EDI * 8);
...
code_r0x0040395a:
  *pbVar13 = *pbVar13 + (char)pbVar13;
  ...
  unaff_EBX = (byte *)((uint)unaff_EBX | (uint)pbStack_8);
...
code_r0x00403991:
    ...
    *pbVar13 = *pbVar13 + (byte)pbVar13;
    ...
    if (bVar6 == 0) {
      ...
      *pbVar13 = *pbVar13;
      *(byte **)(unaff_EBX + -0x3d) = pbStack_8 + *(int *)(unaff_EBX + -0x3d);
      break;
    }
...
code_r0x004039c8:
  ...
  *unaff_EBX = *unaff_EBX + bVar9;
  if (CARRY1(bVar6,bVar9)) {
    ...
    *pbVar21 = *pbVar21;
    bVar10 = *param_2;
    cVar25 = (char)unaff_EBX - *pbStack_8;
    cVar8 = unaff_EDI[0x17];
    ...
    *pcVar15 = *pcVar15 + cVar8;
    ...
    if ((POPCOUNT(bVar6) & 1U) == 0) {
      ...
      *param_2 = *param_2 + bVar10;
      ...
      cVar8 = (char)((uint)unaff_EBX >> 8) - pbStack_8[0x1f];
      unaff_EBX = (byte *)CONCAT22(uVar19,CONCAT11(cVar8,uVar26));
      *pbVar13 = *pbVar13 + bVar9;
      bVar7 = *param_2;
      bVar6 = *pbVar13;
      *pbVar13 = *pbVar13 + bVar9;
      pbStack_8 = pbStack_8 + ((4 - *(int *)pbVar13) - (uint)CARRY1(bVar6,bVar9));
      pbVar13 = (byte *)CONCAT31(uVar17,bVar9);
      param_1 = (byte *)(CONCAT22((short)((uint)param_1 >> 0x10),
...
code_r0x00403aaf:
    ...
    *(byte **)(pbStack_8 + (int)unaff_EDI * 8) =
         param_2 + (uint)(0xd2 < (byte)pcVar15) + *(int *)(pbStack_8 + (int)unaff_EDI * 8);
    pbVar21 = unaff_EBP;
...
code_r0x00403a8f:
    ...
    *unaff_EBX = *unaff_EBX + cVar8;
    ...
    if (*unaff_EBX != 0 && SCARRY1(bVar6,cVar8) == (char)*unaff_EBX < '\0') {
      *pbVar21 = *pbVar21 + bVar7;
      pbStack_8 = (byte *)CONCAT31(uVar17,bVar7 + 0x2d);
  ...
  *pbStack_8 = *pbStack_8 + (char)pbVar21;
code_r0x00403afc:
  unaff_EBX = (byte *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
                               CONCAT11((char)((uint)unaff_EBX >> 8) + unaff_EBX[0x55],
                                        (char)unaff_EBX));
  *pbVar21 = *pbVar21 + (char)pbVar21;
  ...
  bVar6 = *(byte *)CONCAT31(uVar17,bVar7);
  *param_2 = *param_2 + (char)param_1;
  pbVar21 = (byte *)CONCAT31(uVar17,(bVar7 & bVar6) + *pbStack_8);
  *param_1 = *param_1 - (char)((uint)param_2 >> 8);
  goto code_r0x00403b0b;
code_r0x00403b4c:
  while( true ) {
    ...
    *(char *)piVar11 = (char)*piVar11 + (char)piVar11;
    ...
    out(*(undefined4 *)pbStack_2c,(short)param_2);
    ...
    *param_1 = *param_1 + bVar6;
    ...
    while( true ) {
      ...
      *pbVar21 = *pbVar21 + (char)pbVar21;
      *(byte **)pbStack_2c = unaff_EBX + *(int *)pbStack_2c;
      bVar6 = (byte)((uint)param_1 >> 8);
      cVar8 = (char)param_1;
      ...
      *param_2 = *param_2 + cVar8;
      cVar8 = (char)unaff_EBX - pbStack_2c[2];
...
code_r0x00403b18:
      ...
      if (!bVar29) {
        *param_2 = *param_2 + (char)param_1;
        pbVar21 = (byte *)CONCAT31(uVar17,bVar6 | *pbStack_8);
code_r0x00403b73:
        ...
        *unaff_EBX = *unaff_EBX + bVar9;
        ...
        if (CARRY1(bVar6,bVar9)) {
          ...
          *(byte *)piVar11 = (char)*piVar11 + bVar7;
          cVar27 = (char)unaff_EBX - *pbStack_8;
          unaff_EBX = (byte *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
        ...
        *(byte *)puVar22 = (byte)*puVar22 + cVar8;
        do {
          ...
          *pbVar12 = *pbVar12 + bVar9;
          bVar7 = pbStack_28[-0x22];
          *pbVar12 = *pbVar12 + bVar9;
          uVar17 = (undefined3)((uint)pbVar12 >> 8);
          bVar9 = bVar9 | *pbStack_8;
          ...
          *(byte *)puVar22 = (byte)*puVar22 + cVar8;
          bVar7 = bVar9 - *pbVar21;
          pbVar12 = (byte *)CONCAT31(uVar17,bVar7);
          pbStack_8 = pbStack_8 + (-(uint)(bVar9 < *pbVar21) - *(int *)pbVar12);
          ...
          while( true ) {
            ...
            *pbVar12 = *pbVar12 + bVar6;
            if (CARRY1(bVar7,bVar6)) {
              *pbVar12 = *pbVar12 + bVar6;
              unaff_EBX = (byte *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
                                           CONCAT11((byte)((uint)unaff_EBX >> 8) | pbStack_28[-0x1d]
                                                    ,(char)unaff_EBX));
              *pbVar12 = *pbVar12 + bVar6;
              bVar29 = false;
              ...
              while( true ) {
                ...
                *(byte *)puVar16 = (byte)*puVar16 + bVar7;
                pbStack_28 = pbStack_28 + (-(uint)CARRY1((byte)uVar5,bVar7) - *puVar16);
                    ...
                    *pbVar21 = *pbVar21 + bVar9;
                    ...
                    if ((POPCOUNT(bVar9) & 1U) == 0) {
                      ...
                      *pbVar21 = *pbVar21 + bVar9;
                      ...
                      while( true ) {
                        ...
                        *pbVar12 = *pbVar12 + bRam0312382b;
                        pbVar21 = (byte *)CONCAT31(uVar17,bVar7 | *pbStack_8);
                      }
                      *pbVar21 = *pbVar21 + bVar7;
                      bVar7 = bVar7 | *pbStack_8;
                      pcVar15 = (char *)CONCAT31(uVar17,bVar7);
                      out(*(undefined4 *)pbStack_8,(short)pbVar12);
                      ...
                      *pcVar14 = *pcVar14 + bRam0312382b;
                      out(*(undefined4 *)(pbStack_8 + 4),uVar20);
                      do {
