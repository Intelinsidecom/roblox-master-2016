...
byte * __fastcall get_TimerDisplay(undefined4 param_1,byte *param_2)

{
  ...
  cVar35 = (char)((uint)unaff_EBX >> 8) + *(char *)(unaff_EBX + 0x3a);
  pcVar22 = (char *)CONCAT22(uVar66,CONCAT11(cVar35,(char)unaff_EBX));
  *in_EAX = *in_EAX + (char)in_EAX;
  uVar26 = (undefined3)((uint)in_EAX >> 8);
  bVar8 = (char)in_EAX + 0x2aU & *param_2;
  pcVar17 = (char *)CONCAT31(uVar26,bVar8);
  puVar62 = (undefined4 *)(unaff_EDI + *(int *)(unaff_EBP + 0x3a));
  ...
  *param_2 = *param_2 + cVar33;
  ...
  if (SCARRY1(cVar10,*pcVar22) == cVar9 < '\0') {
    *(char **)param_2 = unaff_EBP + *(int *)param_2;
    pcVar22 = (char *)CONCAT22(uVar66,CONCAT11(cVar35 + pcVar22[0x38],(char)unaff_EBX));
  ...
  do {
    while( true ) {
      ...
      *(char *)(in_GS_OFFSET + (int)piVar16) = *(char *)(in_GS_OFFSET + (int)piVar16) + cVar10;
      ppbVar20 = apbStack_1c;
      ppbVar19 = apbStack_1c;
      apbStack_1c[0] = (byte *)CONCAT22(apbStack_1c[0]._2_2_,in_ES);
      pbVar34 = apbStack_1c[0];
      ...
      *(char *)piVar16 = (char)*piVar16 + cVar10;
      ...
      apbStack_1c[0]._0_1_ = (char)in_ES;
      bVar11 = (byte)apbStack_1c;
      apbStack_1c[0]._1_3_ = SUB43(pbVar34,1);
      apbStack_1c[0] = (byte *)CONCAT31(apbStack_1c[0]._1_3_,(char)apbStack_1c[0] + bVar11 * '\x03')
      ;
      ...
      *pbVar15 = *pbVar15 + bVar11;
      ...
      apbStack_1c[0] = (byte *)((uint)apbStack_1c[0]._1_3_ << 8);
    }
code_r0x0040333c:
        ...
        *(byte *)puVar59 = (byte)*puVar59 + bVar8;
        if (CARRY1((byte)uVar21,bVar8)) {
          ...
          *pcVar17 = *pcVar17 + cVar10;
          ...
          puVar55 = (undefined2 *)segment(in_ES,(short)auStack_2c + -2);
          *puVar55 = in_ES;
          ...
          *(byte *)piVar16 = (char)*piVar16 + bVar28;
          ...
          uStack_24 = (byte *)CONCAT22(uVar6,in_ES);
...
code_r0x00403511:
  ...
  *pbVar15 = *pbVar15 + bVar8 + 0x6f;
  pbVar57 = pbVar57 + -*puVar30;
  do {
    uStack_28 = (byte *)CONCAT22(uStack_28._2_2_,in_DS);
...
code_r0x004035e5:
    ...
    *(byte *)piVar16 = (char)*piVar16 + bVar11;
    ...
    if ((char)bVar11 < '\x01') {
      ...
      *pbVar15 = *pbVar15 + bVar11;
      uStack_3c = (undefined4 *)((uint)uStack_3c._2_2_ << 0x10);
    ...
    *pbVar15 = *pbVar15 + bVar11;
    ...
    if (uVar21 < *puVar59) {
      ...
      *(byte *)puVar59 = (byte)*puVar59 + cVar10;
      uStack_3c = (undefined4 *)CONCAT22(uStack_3c._2_2_,in_ES);
...
code_r0x0040362b:
  in_NT = ((uint)pbStack_34 & 0x4000) != 0;
  bVar68 = ((uint)pbStack_34 & 0x400) != 0;
  in_IF = ((uint)pbStack_34 & 0x200) != 0;
  in_TF = ((uint)pbStack_34 & 0x100) != 0;
  in_AF = ((uint)pbStack_34 & 0x10) != 0;
  in_ID = ((uint)pbStack_34 & 0x200000) != 0;
  in_AC = ((uint)pbStack_34 & 0x40000) != 0;
  in_VIP = 0;
  in_VIF = 0;
  cVar10 = (char)pcVar17;
  *pcVar17 = *pcVar17 + cVar10;
...
code_r0x0040369e:
  ...
  *(undefined2 *)uStack_3c = pbStack_34._0_2_;
  cVar9 = (char)pbVar61;
