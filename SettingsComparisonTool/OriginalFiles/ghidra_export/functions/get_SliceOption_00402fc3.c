 ...
 * ============================================================
 * Address     : 00402fc3
 * Raw Name    : get_SliceOption
 * Demangled   : get_SliceOption
 * Prototype   : char * get_SliceOption(undefined4 param_1, byte * param_2)
 * Local Vars  : pcStack_2c, bVar1, bVar2, cVar3, in_EAX, pcVar4, pbVar5, piVar6, uVar7, uVar8, uVar9, bVar10, uVar11, cVar12, uVar13, cVar14, unaff_EBX, pcVar15, cVar16, uVar17, unaff_ESI, in_ES, in_DS, param_1, param_2
 */
...
char * __fastcall get_SliceOption(undefined4 param_1,byte *param_2)

{
  ...
  cVar16 = (char)((uint)unaff_EBX >> 8) + *(char *)(unaff_EBX + 0x1f);
  ...
  *(char *)CONCAT31(uVar7,bVar1) = *(char *)CONCAT31(uVar7,bVar1) + bVar1;
  ...
  cVar16 = cVar16 + *(char *)(CONCAT22(uVar17,CONCAT11(cVar16,uVar13)) + 0x20);
...
code_r0x00403072:
    ...
    *(char *)CONCAT31(uVar7,bVar1) = *(char *)CONCAT31(uVar7,bVar1) + bVar1;
    pcStack_2c = (char *)CONCAT22(pcStack_2c._2_2_,in_DS);
...
code_r0x0040309a:
    cVar16 = (char)pcVar4;
    *pcVar4 = *pcVar4 + cVar16;
    pcStack_2c = (char *)CONCAT22(pcStack_2c._2_2_,in_ES);
    *pcVar4 = *pcVar4 + cVar16;
  ...
  *pbVar5 = *pbVar5 + cVar16;
  ...
  unaff_ESI[0x20a0000] = unaff_ESI[0x20a0000] - cVar12;
  *pcVar4 = *pcVar4 + cVar3;
  cVar14 = (char)pcStack_2c - *unaff_ESI;
  pcVar15 = (char *)CONCAT22((short)((uint)pcStack_2c >> 0x10),
                             CONCAT11((char)((uint)pcStack_2c >> 8) +
                                      *(char *)(CONCAT31((int3)((uint)pcStack_2c >> 8),cVar14) +
                                               0x34),cVar14));
  *pcVar4 = *pcVar4 + cVar3;
  bVar1 = cVar16 + 0x54U & *param_2;
  *(char *)CONCAT31(uVar7,bVar1) = *(char *)CONCAT31(uVar7,bVar1) + bVar1;
