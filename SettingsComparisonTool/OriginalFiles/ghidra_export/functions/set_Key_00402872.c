 ...
 * Raw Name    : set_Key
 * Demangled   : set_Key
 * Prototype   : void set_Key(uint * value, uint * param_2)
 * Local Vars  : param_2, pcStackY_80, puStackY_48, uStackY_2c, puStack_c, uVar1, uVar2, uVar3, uVar4, uVar5, cVar6, bVar7, cVar8, cVar9, in_EAX, pbVar10, pcVar11, uVar12, uVar13, value, puVar14, pbVar15, piVar16, iVar17, pcVar18, piVar19, pbVar20, puVar21, puVar22, uVar23, extraout_ECX, extraout_ECX_00, uVar24, bVar25, cVar26, bVar27, bVar28, cVar29, uVar30, uVar31, uVar32, bVar33, uVar34, unaff_EBX, pcVar35, puVar36, bVar37, unaff_EBP, unaff_ESI, puVar38, puVar39, unaff_EDI, puVar40, in_ES, uVar41, in_CS, uVar42, in_SS, in_DS, in_GS_OFFSET, bVar43, in_AF, in_TF, in_IF, bVar44, bVar45, in_NT, in_AC, in_VIF, in_VIP, in_ID, uVar46, in_stack_fffffff8, in_stack_fffffffc
 */
...
void __fastcall set_Key(uint *value,uint *param_2)

{
  ...
  uVar30 = (undefined2)((uint)in_stack_fffffffc >> 0x10);
  bVar44 = false;
  ...
  do {
    *pbVar10 = *pbVar10 + (char)pbVar10;
    puVar14 = (uint *)CONCAT31((int3)((uint)pbVar10 >> 8),(char)pbVar10 + '*');
get_Value:
    uVar30 = (undefined2)((uint)in_stack_fffffffc >> 0x10);
    unaff_EBX = (char *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
                                 CONCAT11((char)((uint)unaff_EBX >> 8) + unaff_EBX[0x13],
                                          (char)unaff_EBX));
...
code_r0x0040288b:
    in_stack_fffffffc = (uint *)CONCAT22(uVar30,in_DS);
    bVar7 = (byte)((uint)value >> 8);
    bVar25 = bVar7 + *pbVar10;
    ...
    *(byte *)param_2 = (byte)*param_2 + (char)value;
    ...
    value = (uint *)CONCAT22((short)((uint)value >> 0x10),CONCAT11(bVar25 + *pbVar10,(char)value));
...
code_r0x00402898:
    ...
    *pbVar10 = *pbVar10 + (char)pbVar10;
    ...
    do {
      ...
      *pbVar10 = *pbVar10 + bVar25;
      *pbVar10 = *pbVar10 | bVar25;
      bVar43 = CARRY1((byte)*value,bVar7);
...
code_r0x004028db:
        if (!bVar43) {
          unaff_EBX = (char *)CONCAT31((int3)((uint)puVar36 >> 8),(char)puVar36 - (byte)*unaff_ESI);
          goto get_Value;
        }
        *(byte *)puVar14 = (byte)*puVar14 + (char)puVar14;
...
code_r0x004028e2:
        ...
        *pbVar10 = *pbVar10 + bVar33;
        in_stack_fffffffc =
             (uint *)((uint)(in_NT & 1) * 0x4000 | (uint)SCARRY1(bVar25,bVar33) * 0x800 |
                      (uint)(in_IF & 1) * 0x200 | (uint)(in_TF & 1) * 0x100 |
                      (uint)((char)*pbVar10 < '\0') * 0x80 | (uint)(*pbVar10 == 0) * 0x40 |
                      (uint)(in_AF & 1) * 0x10 | (uint)((POPCOUNT(*pbVar10) & 1U) == 0) * 4 |
                      (uint)CARRY1(bVar7,bVar33) | (uint)(in_ID & 1) * 0x200000 |
        ...
        *pbVar10 = *pbVar10 + bVar7;
        ...
        if (bVar7 < 0x8e && (byte)(bVar7 + 0x72) != '\0') {
          ...
          *(byte *)((int)puVar14 + 0x6f) = *(byte *)((int)puVar14 + 0x6f) + bVar33;
        }
code_r0x00402905:
        ...
        *(byte *)puVar14 = (byte)*puVar14 + cVar6;
        ...
        uVar46 = func_0x7346291c(in_stack_fffffff8,in_stack_fffffffc);
        *(char *)uVar46 = *(char *)uVar46 + (char)uVar46;
        ...
        in_stack_fffffff8 = (uint *)CONCAT22((short)((uint)in_stack_fffffff8 >> 0x10),in_ES);
        in_stack_fffffffc = puVar36;
        while( true ) {
          pcVar35 = (char *)((int)uVar46 * 2);
          *pcVar35 = *pcVar35 - (char)value;
          uVar12 = *puVar36;
              ...
              *pbVar10 = *pbVar10 + bVar33;
              ...
              if (!bVar45) {
                ...
                *(byte *)value = (byte)*value + cVar6;
                ...
                value = (uint *)CONCAT22(uVar30,CONCAT11(bVar27 + bVar37,bVar7));
                ...
                *(byte *)puVar14 = (byte)*puVar14 + cVar6;
                value = (uint *)CONCAT22(uVar30,CONCAT11(bVar27 + bVar37 | (byte)*puVar14,
                                                         bVar7 | (byte)uVar12));
                unaff_EDI = puVar40;
    ...
    unaff_EBX = (char *)CONCAT22((short)((uint)puVar36 >> 0x10),
                                 CONCAT11((char)((uint)puVar36 >> 8) +
                                          *(char *)(CONCAT31((int3)((uint)puVar36 >> 8),cVar8) +
                                                   0x12),cVar8));
    *pcVar35 = *pcVar35 + cVar6;
    pbVar10 = (byte *)CONCAT31(uVar23,cVar6 + 0x2aU & (byte)*param_2);
...
code_r0x00402a9b:
    ...
    *pcVar35 = *pcVar35 + cVar9;
    value = (uint *)CONCAT22((short)((uint)value >> 0x10),
                             CONCAT11((byte)((uint)value >> 8) | bRama07b0222,cVar8));
    *pcVar35 = *pcVar35 + cVar9;
      ...
      if ((bVar7 & 1) == 0) {
        ...
        *(byte *)param_2 = (byte)*param_2 + bVar7;
        ...
        while( true ) {
          ...
          *pcVar35 = *pcVar35 + bVar7;
          value = (uint *)CONCAT22((short)((uint)value >> 0x10),
                                   CONCAT11((byte)((uint)value >> 8) | bRam7d160243,bVar25));
          bVar44 = ((uint)uStackY_2c & 0x400) != 0;
...
code_r0x00402b33:
          ...
          *(byte *)puVar36 = (byte)*puVar36 + (char)((uint)value >> 8);
          uVar41 = in_ES;
          in_ES = in_SS;
          while( true ) {
            bVar25 = (byte)puVar36 | (byte)((uint)value >> 8);
...
code_r0x00402bd1:
              uVar12 = *puVar36;
              uVar1 = *puVar36;
              *puVar36 = (uint)((byte *)(uVar1 + (int)value) + bVar43);
              bVar7 = POPCOUNT(*puVar36 & 0xff);
              uVar41 = in_SS;
              if ((SCARRY4(uVar12,(int)value) != SCARRY4((int)(uVar1 + (int)value),(uint)bVar43)) ==
...
code_r0x00402bdb:
                ...
                *pcVar35 = *pcVar35 + (char)pcVar35;
                ...
                bVar7 = (byte)puVar36 | (byte)((uint)value >> 8);
                cVar6 = *pcVar35;
                uVar23 = (undefined3)((uint)pcVar35 >> 8);
                pcVar35 = (char *)CONCAT31(uVar23,cVar6);
                *pcVar35 = *pcVar35 + cVar6;
                ...
                *pcVar35 = *pcVar35 + cVar6;
                ...
                do {
                  ...
                  value = (uint *)CONCAT31((int3)((uint)value >> 8),bVar7 + bVar43);
                  ...
                  *piVar19 = (int)((int)value +
                  ...
                  while( true ) {
                    ...
                    *pcVar35 = *pcVar35 + cVar8;
                    pcVar35 = (char *)(CONCAT31(uVar23,cVar6 + '\x19') | *puVar14);
                    bVar7 = (byte)pcVar35;
                    ...
                    *pcVar35 = *pcVar35 + bVar25;
                    ...
                    if (SCARRY1(bVar25,'\x02') == cVar6 < '\0') {
                      ...
                      *(char **)pcVar18 = pcVar18;
                      UNLOCK();
                      *pcVar35 = *pcVar35 + (char)pcVar35;
                      pbVar10 = (byte *)CONCAT31((int3)((uint)pcVar35 >> 8),(byte)*value);
...
code_r0x00402a8f:
    *(byte *)puVar36 = (byte)*puVar36 + (char)value;
    uVar12 = *puVar14;
  ...
  do {
    while( true ) {
      cVar29 = (char)value;
      cVar26 = (char)((uint)value >> 8) + (char)((uint)pbVar10 >> 8);
      value = (uint *)CONCAT22((short)((uint)value >> 0x10),CONCAT11(cVar26,cVar29));
      cVar6 = (char)pbVar10;
      *pbVar10 = *pbVar10 + cVar6;
  ...
  do {
    ...
    *(char *)CONCAT31(uVar23,bVar25) = *(char *)CONCAT31(uVar23,bVar25) + bVar25;
    ...
    cVar6 = cVar8 + *(char *)CONCAT31(uVar23,cVar8) +
            (CARRY1(cVar6 + 0x2fU,(byte)*value) || CARRY1(bVar7,0xf4 < bVar25));
    pcVar35 = (char *)CONCAT31(uVar23,cVar6);
    ...
    *pcVar35 = *pcVar35 + cVar6;
    uStackY_2c = (uint *)CONCAT22(uStackY_2c._2_2_,uVar41);
    pbVar15 = (byte *)CONCAT22((short)((uint)pcVar11 >> 0x10),
                               CONCAT11(cVar9 - (byte)*unaff_ESI,(char)pcVar11));
    unaff_EBP = (uint *)((int)unaff_EBP + *(int *)(pbVar15 + (int)value));
      ...
      *(byte *)unaff_ESI = (byte)*unaff_ESI + bVar7;
      ...
      if (CARRY1((byte)uVar12,bVar7)) {
        *pcVar35 = *pcVar35 + bVar7;
        ...
        if ('\0' < (char)bVar7) {
          ...
          *pbVar10 = *pbVar10 + bVar33;
          ...
          value = (uint *)CONCAT22((short)((uint)value >> 0x10),CONCAT11(bVar27,cVar6));
        ...
        *(char *)piVar19 = *(char *)piVar19 + (char)piVar19;
        ...
        value = (uint *)CONCAT31(uVar23,bVar7);
        ...
        *(byte **)pbVar15 = (byte *)(*(int *)pbVar15 + (int)puVar36);
        ...
        value = (uint *)CONCAT22(uVar31,CONCAT11(bVar25 + *(byte *)((int)puVar40 + -0x79),bVar7));
...
code_r0x00402e0a:
  ...
  *pbVar10 = *pbVar10 + (char)pbVar10;
  bVar43 = false;
  bVar25 = (byte)((uint)value >> 8) | bRam052b0603;
  value = (uint *)CONCAT22((short)((uint)value >> 0x10),CONCAT11(bVar25,(char)value));
  puVar14 = puVar38;
code_r0x00402e19:
  ...
  *(char *)piVar19 = (char)*piVar19 + cRam89280411;
  cVar6 = (char)value;
  value = (uint *)CONCAT22((short)((uint)value >> 0x10),
                           CONCAT11((byte)((uint)value >> 8) | (byte)*puVar36,cVar6));
...
code_r0x00402e5a:
  *pbVar20 = *pbVar20 + (char)pbVar20;
  value = (uint *)CONCAT22((short)((uint)value >> 0x10),
                           CONCAT11((byte)((uint)value >> 8) | (byte)*puVar36,(char)value));
  puVar38 = puVar14 + (uint)bVar44 * -2 + 1;
  out(*puVar14,(short)puVar36);
...
code_r0x00402e81:
  ...
  *pbVar20 = *pbVar20 + bVar25;
  ...
  puStackY_48 = (uint *)CONCAT22(puStackY_48._2_2_,uVar41);
  do {
    uVar12 = *puVar14;
    bVar7 = (byte)pbVar10;
    *(byte *)puVar14 = (byte)*puVar14 + bVar7;
...
code_r0x00402ecc:
      *pbVar20 = *pbVar20 + (byte)pbVar20;
      ...
      if ((char)bVar7 < '\x01') {
        uVar12 = *puVar36;
        *(byte *)puVar36 = (byte)*puVar36 + (byte)value;
        *(char *)((int)pcVar35 * 2) = *(char *)((int)pcVar35 * 2) - CARRY1((byte)uVar12,(byte)value)
        ;
        bVar43 = 0x81 < bVar7;
        bVar7 = bVar7 + 0x7e;
...
code_r0x00402eb4:
      ...
      *(byte *)puVar36 = (byte)*puVar36 + (char)value;
      puStackY_48 = (uint *)CONCAT22(puStackY_48._2_2_,uVar41);
      in_DS = uVar41;
      if ((byte)*puVar36 != 0 && SCARRY1((byte)uVar12,(char)value) == (char)(byte)*puVar36 < '\0') {
        *pcVar35 = *pcVar35 + bVar7;
    ...
    *pbVar10 = *pbVar10 + bVar25;
    ...
    while( true ) {
      ...
      *pcVar35 = *pcVar35 + bVar7;
      ...
      puVar14[(int)puVar40 * 2] =
           (uint)((int)puVar36 + (uint)(0xd2 < bVar7) + puVar14[(int)puVar40 * 2]);
      puStackY_48 = (uint *)CONCAT22((short)((uint)puStackY_48 >> 0x10),uVar41);
      uVar12 = *puVar14;
      *(byte *)puVar14 = (byte)*puVar14 + bVar25;
...
code_r0x00402f16:
      ...
      while( true ) {
        ...
        *(byte *)puVar36 = (byte)*puVar36 + cVar9;
        value = (uint *)CONCAT22((short)((uint)value >> 0x10),
                                 CONCAT11((char)((uint)value >> 8) + (byte)*puVar36,
                                          cVar9 - (byte)*puVar36));
        *(byte *)puVar21 = (byte)*puVar21 + (char)puVar21;
code_r0x00402f3b:
        cVar9 = (char)puVar36;
        ...
        *(byte *)puVar21 = (byte)*puVar21 + cVar6;
        ...
        ;
        value = (uint *)CONCAT22(uVar31,CONCAT11(cVar29,bVar27));
        uVar12 = *puVar36;
...
code_r0x0040309a:
            cVar6 = (char)pcVar35;
            *pcVar35 = *pcVar35 + cVar6;
            pcStackY_80 = (char *)CONCAT22(pcStackY_80._2_2_,uVar41);
            *pcVar35 = *pcVar35 + cVar6;
          ...
          *pcVar35 = *pcVar35 + cVar8;
          ...
          pcVar11 = (char *)CONCAT22((short)((uint)pcStackY_80 >> 0x10),
...
code_r0x00402e36:
  *(byte *)value = (byte)*value + (char)puVar36;
