 ...
 * ============================================================
 * Address     : 004034d5
 * Raw Name    : <CreateReportText>b__8
 * Demangled   : <CreateReportText>b__8
 * Prototype   : byte * <CreateReportText>b__8(char * info, uint * param_2, byte * param_3)
 * Local Vars  : uStack_c, pbStack_4, uVar1, pcVar2, uVar3, iVar4, puVar5, bVar6, bVar7, cVar8, cVar9, bVar10, bVar11, bVar12, in_EAX, pcVar13, pcVar14, uVar15, piVar16, pbVar17, pbVar18, pbVar19, pbVar20, pbVar21, puVar22, uVar23, uVar24, iVar25, extraout_ECX, extraout_ECX_00, uVar26, puVar27, cVar28, uVar29, info, unaff_EBX, pbVar30, bVar31, cVar32, bVar33, uVar34, puVar35, puVar36, piVar37, piVar38, puVar39, puVar40, puVar41, puVar42, puVar43, puVar44, puVar45, puVar46, puVar47, puVar48, puVar49, puVar50, puVar51, puVar52, puVar53, puVar54, unaff_EBP, pbVar55, unaff_ESI, pbVar56, unaff_EDI, puVar57, in_ES, in_CS, in_SS, uVar58, uVar59, bVar60, in_AF, in_TF, in_IF, bVar61, bVar62, in_NT, in_AC, in_VIF, in_VIP, in_ID, uVar63, unaff_retaddr, param_2, param_3
 */
...
byte * __fastcall <CreateReportText>b__8(char *info,uint *param_2,byte *param_3)
...
code_r0x004034d5:
  ...
  *in_EAX = *in_EAX + (byte)in_EAX;
  info = (char *)CONCAT22((short)((uint)info >> 0x10),
                          CONCAT11((char)((uint)info >> 8) + bVar6 | (byte)*param_2,(char)info));
  ...
  in_EAX = (byte *)CONCAT31(uVar23,bVar7);
...
code_r0x004034f3:
  ...
  *(byte *)unaff_ESI = (byte)*unaff_ESI + bVar6;
  if (CARRY1((byte)uVar15,bVar6)) {
    ...
    info[0x2a0a0000] = info[0x2a0a0000] - (char)info;
    pbStack_4 = (byte *)((uint)pbStack_4 & 0xffff0000);
    info = (char *)CONCAT22((short)((uint)info >> 0x10),
                            CONCAT11((char)((uint)info >> 8) + (char)*piVar16,(char)info));
    *(byte *)piVar16 = (char)*piVar16 + bVar6;
    ...
    pbVar17[0x6fe1412] = pbVar17[0x6fe1412] + bVar6;
    uVar15 = *unaff_ESI;
    *(byte *)unaff_ESI = (byte)*unaff_ESI + bVar6;
    if (!CARRY1((byte)uVar15,bVar6)) {
...
code_r0x00403529:
  ...
  bVar7 = (byte)in_EAX;
  *in_EAX = *in_EAX + bVar7;
  if (!CARRY1(bVar6,bVar7)) goto code_r0x004034d5;
  *in_EAX = *in_EAX + bVar7;
  uVar23 = (undefined3)((uint)in_EAX >> 8);
...
code_r0x00403549:
  ...
  *(byte *)piVar16 = (char)*piVar16 + bVar6;
  ...
  if ((char)bVar6 < '\x01') {
    *(byte *)param_2 = (byte)*param_2 + (char)info;
...
code_r0x00403565:
  ...
  *(byte *)puVar57 = (byte)*puVar57 + (char)piVar16 + (char)*piVar16;
  unaff_ESI = puVar57 + 1;
  out(*puVar57,(short)param_2);
  pcVar14 = (char *)CONCAT31((int3)((uint)piVar16 >> 8),uRam8c0a0000);
code_r0x00403579:
  *info = *info + (char)pcVar14;
...
code_r0x004035e5:
      ...
      *(byte *)unaff_ESI = (byte)*unaff_ESI + bVar6;
      if (CARRY1((byte)uVar15,bVar6)) {
        *pcVar14 = *pcVar14 + bVar6;
        ...
        if ('\0' < (char)bVar6) {
          ...
          *pbVar17 = *pbVar17 + (char)((uint)info >> 8);
      ...
      info = (char *)CONCAT31((int3)((uint)info >> 8),
                              (byte)info | *(byte *)((int)(param_2 + 0xa004000) + (int)unaff_EDI));
      puVar57 = unaff_ESI;
      ...
      *param_2 = (uint)(pbVar17 + (uint)CARRY1(bVar6,bVar7) + *param_2);
      ...
      if ((POPCOUNT(*param_2 & 0xff) & 1U) == 0) {
        ...
        *pcVar14 = *pcVar14 + bVar7 + 0x28;
        info = (char *)CONCAT22((short)((uint)info >> 0x10),
                                CONCAT11((byte)((uint)info >> 8) | unaff_EBX[(int)info],(char)info))
        ;
...
code_r0x0040362b:
  ...
  *pcVar14 = *pcVar14 + cVar8;
  info = (char *)CONCAT22((short)((uint)info >> 0x10),
                          CONCAT11((byte)((uint)info >> 8) | (byte)*param_2,(char)info));
  unaff_EBX = (byte *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
...
code_r0x004036a6:
    ...
    *(undefined2 *)(uStack_c + -1) = in_ES;
    ...
    if (bVar60) {
      ...
      *pbVar17 = *pbVar17 + bVar6;
      iVar25 = (int)info - *param_2;
      info = (char *)CONCAT22((short)((uint)iVar25 >> 0x10),
    ...
    uVar23 = (undefined3)((uint)pbVar17 >> 8);
    if (bVar60) break;
    *(byte *)param_2 = (byte)*param_2 + (byte)info;
...
code_r0x0040369e:
  ...
  *pbVar17 = *pbVar17 + bVar6;
  uVar24 = (uint3)((uint)info >> 8);
  pbVar18 = (byte *)CONCAT31(uVar24,(byte)info | *unaff_EBX);
  ...
  *pbVar17 = *pbVar17 + bVar6;
  ...
  pbVar17 = (byte *)CONCAT31(uVar23,bVar6);
  *(byte *)(unaff_EDI + 0x1bc28000) = (byte)unaff_EDI[0x1bc28000] - (char)((uint)info >> 8);
  ...
  *(undefined2 *)uStack_c = pbStack_4._0_2_;
  ...
  if (cVar9 != '\0' && (char)(byte)*param_2 <= cVar28) {
    ...
    *pcVar14 = *pcVar14 + cVar9;
    ...
    do {
      piVar16 = (int *)((ulonglong)uVar63 >> 0x20);
      pcVar14 = (char *)uVar63;
...
_ctor:
        ...
        *(byte *)param_2 = (byte)*param_2;
        ...
        bVar6 = *pbVar17;
        *pbVar17 = *pbVar17 + bVar7;
        puVar57 = (uint *)((int)unaff_ESI + (uint)CARRY1(bVar6,bVar7) + *(int *)pbVar17);
        pbVar17 = (byte *)CONCAT31(uVar23,bVar7);
        uStack_c = puVar35;
        break;
      }
...
code_r0x0040371e:
      ...
      *(char *)puVar57 = (char)*puVar57;
      ...
      if ((char)*puVar57 != '\0') {
        ...
        *(uint **)((int)puVar35 + -4) = unaff_ESI;
        ...
        bVar60 = false;
        pcVar14 = (char *)CONCAT31((int3)((uint)pbVar17 >> 8),*pbVar56);
  ...
  uVar63 = CONCAT44(param_2,pbVar17);
...
code_r0x0040375a:
  pbVar17 = (byte *)uVar63;
  *pbVar17 = *pbVar17 + (char)uVar63;
  bVar60 = CARRY1((byte)((uint)pbVar18 >> 8),*pbVar17);
  ...
  *pbVar17 = *pbVar17 | bVar6;
  ...
  uRam2609fffc = in_ES;
  *pbVar17 = *pbVar17 | bVar6;
  uVar63 = CONCAT44(CONCAT31((int3)((uint)puVar27 >> 8),bVar7 | (byte)uVar15),pbVar17);
code_r0x004037a7:
  while( true ) {
    pbVar17 = (byte *)((ulonglong)uVar63 >> 0x20);
    uVar58 = (undefined2)((ulonglong)uVar63 >> 0x20);
    out(*unaff_ESI,uVar58);
    out(unaff_ESI[(uint)bVar61 * -2 + 1],uVar58);
    puVar57 = (uint *)((int)unaff_EDI + (int)pbVar17);
    uVar15 = *puVar57;
    uVar1 = (uint)uVar63 + *puVar57;
    *puVar57 = uVar1 + bVar60;
    iVar25 = *piVar37 + *(int *)(pcVar14 + (int)pbVar17) +
    ...
    *(undefined2 *)(piVar37 + 1) = unaff_retaddr;
    bVar6 = *pbVar18;
    ...
    *(undefined2 *)piVar37 = in_ES;
    ...
    piVar16 = (int *)CONCAT31(uVar23,cVar8);
    unaff_ESI = (uint *)(pcVar13 + *piVar16);
    bVar6 = cVar8 + (char)*piVar16;
    ...
    *pbVar17 = *pbVar17 + bVar6;
    ...
    unaff_EBX = (byte *)CONCAT31((int3)((uint)unaff_EBX >> 8),cVar9);
    uVar63 = CONCAT44(pbVar17,pcVar13);
  }
  *pcVar13 = *pcVar13 + bVar6;
...
code_r0x00403825:
  ...
  *pbVar18 = *pbVar18 + (char)pbVar17;
  bVar6 = ((bVar11 - bVar31) - CARRY1(bVar6,bVar11)) + *pbVar17;
  pbVar20 = (byte *)CONCAT31(uVar23,bVar6);
  if ((POPCOUNT(bVar6) & 1U) != 0) {
    pbVar17 = *(byte **)((int)piVar38 + -0x18);
...
code_r0x0040390c:
    ...
    *pbVar30 = *pbVar30 + bVar31;
    if (!CARRY1(bVar6,bVar31)) {
      out(*(undefined4 *)pbVar56,(short)pbVar17);
      bVar6 = (cVar9 - (char)*piVar16) - CARRY1(bVar6,bVar31);
    ...
    *pcVar14 = *pcVar14 + cVar8 + 's';
    bVar6 = cVar8 - 0xf;
    pbVar17 = *(byte **)((int)puVar40 + -4);
    *(char *)CONCAT31(uVar23,bVar6) = *(char *)CONCAT31(uVar23,bVar6) + bVar6;
    bVar31 = cVar8 + 0x1e;
    pbVar19 = (byte *)CONCAT31(uVar23,bVar31);
    *(byte **)(pbVar56 + (int)unaff_EDI * 8) =
         pbVar17 + (uint)(0xd2 < bVar6) + *(int *)(pbVar56 + (int)unaff_EDI * 8);
    puVar35 = (undefined4 *)((int)puVar40 + -4);
...
code_r0x00403916:
  ...
  *(byte **)(pbVar56 + (int)unaff_EDI * 8) =
       pbVar17 + (uint)(0xd2 < bVar12) + *(int *)(pbVar56 + (int)unaff_EDI * 8);
...
code_r0x00403991:
      ...
      *pbVar20 = *pbVar20 + (byte)pbVar20;
      ...
      if (bVar6 == 0) {
        ...
        *pbVar17 = *pbVar17 + cVar8;
        pbVar17 = (byte *)CONCAT31((int3)((uint)pbVar17 >> 8),bVar10 - *pbVar30);
        *pbVar30 = *pbVar30;
      ...
      *(byte *)piVar16 = (char)*piVar16 + bVar6;
      pbVar18 = (byte *)CONCAT22((short)((uint)pbVar18 >> 0x10),CONCAT11(bVar31 | *pbVar17,cVar8));
      pbVar56 = pbVar19 + *piVar16;
      pcVar14 = (char *)((int)piVar16 + *piVar16);
...
code_r0x00403a24:
      ...
      *pcVar14 = *pcVar14 + cVar8;
      ...
      bVar6 = cVar8 + 2;
      if ((POPCOUNT(bVar6) & 1U) != 0) {
        pcVar14 = (char *)CONCAT31(uVar23,bVar6 + *pbVar17);
        pbVar20 = pbVar56;
        if ((POPCOUNT(bVar6 + *pbVar17) & 1U) == 0) goto code_r0x00403a7d;
code_r0x00403ad1:
        *(byte **)(pbVar56 + (int)unaff_EDI * 8) =
             pbVar17 + (uint)(0xd2 < (byte)pcVar14) + *(int *)(pbVar56 + (int)unaff_EDI * 8);
      ...
      *pbVar18 = *pbVar18 + (char)pbVar17;
      ...
      if ((POPCOUNT(bVar6) & 1U) == 0) {
        *pbVar20 = *pbVar20 + bVar6;
        ...
        bVar6 = *pbVar17;
        *pbVar17 = *pbVar17 + (char)pbVar18;
        if (SCARRY1(bVar6,(char)pbVar18) == (char)*pbVar17 < '\0') {
code_r0x00403aaf:
          cVar8 = (char)pbVar19 + '(';
          pbVar19 = (byte *)CONCAT31((int3)((uint)pbVar19 >> 8),cVar8);
          *(byte **)pbVar19 = pbVar19 + *(int *)pbVar19;
...
code_r0x00403aa1:
    ...
    *pbVar17 = *pbVar17 + bVar31;
    if (CARRY1(bVar6,bVar31)) {
      ...
      if (CARRY1(bVar6,bVar10)) {
        ...
        *pbVar19 = *pbVar19 + cVar9;
        ...
        pbVar17 = (byte *)CONCAT22((short)((uint)pbVar17 >> 0x10),
                                   CONCAT11((char)((uint)pbVar17 >> 8) - pbVar30[-0x3a],
                                            (char)pbVar17));
        *pbVar19 = *pbVar19 + cVar9;
        uVar34 = (undefined2)((uint)pbVar30 >> 0x10);
        bVar33 = (byte)((uint)pbVar30 >> 8) | pbVar17[0x32];
        ...
        *pbVar19 = *pbVar19 + cVar8;
        uVar59 = CONCAT11((bVar10 | bVar6) + bVar11 | *pbVar17,bVar31 - bVar12);
      ...
      *pcVar13 = *pcVar13 + (char)((uint)pbVar17 >> 8);
      cVar9 = *pcVar13;
      ...
      *pbVar30 = *pbVar30 + cVar8;
      ...
      if (*pbVar30 != 0 && SCARRY1(bVar6,cVar8) == (char)*pbVar30 < '\0') {
        ...
        *(byte **)(pbVar20 + (int)unaff_EDI * 8) =
             pbVar17 + (uint)(0xd2 < bVar31) + *(int *)(pbVar20 + (int)unaff_EDI * 8);
        *(undefined2 *)((int)puVar35 + -4) = in_ES;
...
code_r0x00403b73:
    ...
    *pbVar19 = *pbVar19 + (byte)pbVar19;
    ...
    pcVar14 = (char *)CONCAT31(uVar23,bVar6);
    uVar63 = CONCAT44(pbVar17,pcVar14);
    if ((POPCOUNT(bVar6) & 1U) == 0) {
      *pcVar14 = *pcVar14 + bVar6;
      *pbVar56 = *pbVar56 + 1;
    ...
    *(byte *)puVar57 = (byte)*puVar57 + cVar8;
    ...
    pbVar18 = (byte *)CONCAT31((int3)((uint)pbVar17 >> 8),bVar6);
    if (10 < (byte)pbVar17) {
    ...
    *(byte *)puVar57 = (byte)*puVar57 + cVar8;
    do {
      ...
      *pbVar18 = *pbVar18 + bVar31;
      ...
      pbVar17 = (byte *)CONCAT31(uVar23,bVar31);
      cVar9 = (char)pbVar30 - *pbVar56;
      ...
      pcVar14 = (char *)CONCAT22((short)((uint)pcVar14 >> 0x10),
                                 CONCAT11((char)((uint)pcVar14 >> 8) + *pbVar17,cVar8));
      *(byte *)puVar57 = (byte)*puVar57 + cVar8;
      bVar7 = bVar31 - *pbVar17;
      pbVar18 = (byte *)CONCAT31(uVar23,bVar7);
      pbVar56 = pbVar56 + (-(uint)(bVar31 < *pbVar17) - *(int *)pbVar18);
  ...
  *pbVar19 = *pbVar19 + bVar6;
  ...
  while( true ) {
    ...
    *(byte **)pbVar19 = pbVar19 + (uint)bVar60 + *(int *)pbVar19;
    ...
    pbVar19[(int)pbVar17] = pbVar19[(int)pbVar17] + (char)pbVar30;
    *pbVar19 = *pbVar19 + (char)pbVar19;
            ...
            do {
              ...
              *(byte *)puVar22 = (byte)*puVar22 + (char)puVar22;
              ...
              do {
                ...
                *pcVar13 = *pcVar13 + bVar31;
                pbVar17 = (byte *)CONCAT31(uVar23,bVar31 | (byte)*puVar57);
                while( true ) {
                  *pbVar17 = *pbVar17 + (byte)pbVar17;
                  uVar23 = (undefined3)((uint)pbVar17 >> 8);
                  bVar7 = (byte)pbVar17 | (byte)*puVar57;
                  puVar22 = (uint *)CONCAT31(uVar23,bVar7);
                  ...
                  *pcVar13 = *pcVar13 + bVar7;
                  pbVar17 = (byte *)CONCAT31(uVar23,bVar7 | (byte)*puVar57);
                  do {
                    do {
                      bVar31 = (byte)pbVar17;
                      *pbVar17 = *pbVar17 + bVar31;
                      cVar28 = (char)pbVar30;
                      pbVar30 = (byte *)CONCAT22((short)((uint)pbVar30 >> 0x10),
                                                 CONCAT11((byte)((uint)pbVar30 >> 8) | *pbVar17,
                                                          cVar28));
                      *pbVar17 = bVar31;
                      *pbVar17 = *pbVar17 + bVar31;
                      cVar9 = (char)((uint)pcVar14 >> 8) + *pbVar17;
                      pcVar14 = (char *)((uint)CONCAT21((short)((uint)pcVar14 >> 0x10),cVar9) << 8);
                      uVar23 = (undefined3)((uint)pbVar17 >> 8);
                      bVar31 = bVar31 & *pbVar17;
                      pbVar17 = (byte *)CONCAT31(uVar23,bVar31);
                      bVar7 = *pbVar30;
                      *pbVar30 = *pbVar30 + cVar9;
                      ...
                      *(undefined2 *)(puVar54 + -8) = in_ES;
                      while( true ) {
                        ...
                        *pbVar18 = *pbVar18 + bRam0312382b;
                        pbVar17 = (byte *)CONCAT31(uVar23,bVar7 | *pbVar56);
                      }
                      *pbVar17 = *pbVar17 + bVar7;
                      bVar7 = bVar7 | *pbVar56;
                      pcVar14 = (char *)CONCAT31(uVar23,bVar7);
