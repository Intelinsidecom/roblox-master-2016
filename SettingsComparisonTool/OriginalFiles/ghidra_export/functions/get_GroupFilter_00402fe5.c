 ...
 * ============================================================
 * Address     : 00402fe5
 * Raw Name    : get_GroupFilter
 * Demangled   : get_GroupFilter
 * Prototype   : char * get_GroupFilter(undefined4 param_1, byte * param_2)
 * Local Vars  : pcStack_24, bVar1, bVar2, cVar3, in_EAX, pcVar4, pbVar5, piVar6, uVar7, uVar8, uVar9, bVar10, uVar11, cVar12, uVar13, cVar14, unaff_EBX, pcVar15, cVar16, param_1, uVar17, param_2, unaff_ESI, in_ES, in_DS
 */
...
char * __fastcall get_GroupFilter(undefined4 param_1,byte *param_2)

{
  ...
  cVar16 = (char)((uint)unaff_EBX >> 8) + *(char *)(unaff_EBX + 0x21);
