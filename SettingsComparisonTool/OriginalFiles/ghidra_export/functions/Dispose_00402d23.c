 ...
 * Local Vars  : unaff_retaddr, pcStack_58, uStack_20, uStack_8, puStack_4, uVar1, uVar2, bVar3, cVar4, param_1, bVar5, param_2, in_EAX, pbVar6, pcVar7, piVar8, pbVar9, puVar10, puVar11, puVar12, pbVar13, uVar14, iVar15, uVar16, bVar17, bVar18, cVar19, uVar20, bVar21, uVar22, cVar23, unaff_EBX, pcVar24, bVar25, cVar26, uVar27, unaff_EBP, unaff_ESI, pbVar28, pbVar29, pbVar30, unaff_EDI, in_ES, in_SS, in_DS, bVar31, bVar32
 */
...

{
  ...
  do {
    ...
    uVar2 = *unaff_EDI;
    *in_EAX = *in_EAX - (char)((uint)param_2 >> 8);
    *in_EAX = *in_EAX + (char)in_EAX;
    puStack_4 = (uint *)CONCAT22(puStack_4._2_2_,in_ES);
    pbVar13 = (byte *)CONCAT22((short)((uint)unaff_EBX >> 0x10),
                               CONCAT11((char)((uint)unaff_EBX >> 8) - *unaff_ESI,(char)unaff_EBX));
    unaff_EBP = unaff_EBP + *(int *)(pbVar13 + (int)param_1);
    pbVar6 = (byte *)CONCAT31((int3)((uint)param_2 >> 8),(char)param_2 + (byte)uVar2);
    while( true ) {
      pbVar28 = pbVar6;
      uVar27 = (undefined2)((uint)pbVar13 >> 0x10);
      bVar25 = (char)((uint)pbVar13 >> 8) + pbVar13[0x18];
      *in_EAX = *in_EAX + (char)in_EAX;
      pbVar6 = (byte *)CONCAT31((int3)((uint)in_EAX >> 8),(char)in_EAX + 'o');
      cVar26 = (char)param_1;
      *pbVar28 = *pbVar28 + cVar26;
      bVar21 = *unaff_ESI;
      bVar5 = (byte)((uint)param_1 >> 8);
      bVar3 = *pbVar6;
      pbVar6 = pbVar6 + (uint)CARRY1(bVar5,*pbVar6) + *(int *)pbVar6;
      *pbVar28 = *pbVar28 + cVar26;
      cVar23 = ((char)pbVar13 - bVar21) - *unaff_ESI;
      bVar21 = *(byte *)((int)unaff_EDI + 0x1a);
      *pbVar6 = *pbVar6 + (char)pbVar6;
      param_1 = (byte *)CONCAT22((short)((uint)param_1 >> 0x10),
                                 CONCAT11(bVar5 + bVar3 + bVar21 | *pbVar28,cVar26));
      pbVar6 = pbVar6 + *(int *)pbVar28;
      ...
      *pbVar6 = *pbVar6 + cVar4;
      ...
      pcVar24 = (char *)(CONCAT31((int3)(CONCAT22(uVar27,CONCAT11(bVar25,(char)pbVar13)) >> 8),
                                  cVar23) + -1);
      *pcVar7 = *pcVar7 + bVar3;
      *pcVar7 = *pcVar7 + bVar3;
      ...
      *pbVar28 = *pbVar28 + cVar26;
      ...
      out(*(undefined4 *)unaff_ESI,(short)pbVar28);
      *pcVar7 = *pcVar7;
      cVar4 = (char)pcVar7;
      *pcVar7 = *pcVar7 + cVar4;
      ...
      *pcVar7 = *pcVar7 + cVar4;
      ...
      out(*(undefined4 *)pbVar6,(short)pbVar28);
      *param_1 = *param_1;
      bVar21 = bVar21 | (byte)*unaff_EDI;
      pbVar6 = (byte *)CONCAT31((int3)((uint)pbVar28 >> 8),bVar21);
      ...
      *(byte **)(unaff_ESI + (int)unaff_EDI * 8) =
      ...
      in_EAX = (char *)CONCAT31(uVar14,bVar5);
      bVar3 = *unaff_ESI;
        ...
        *in_EAX = *in_EAX + bVar5;
        ...
        if ('\0' < (char)bVar5) {
          ...
          *pbVar13 = *pbVar13 + bVar17;
          uVar20 = CONCAT11((byte)((uint)pbVar28 >> 8) | bVar25,bVar21);
          pbVar6 = (byte *)CONCAT22((short)((uint)pbVar28 >> 0x10),uVar20);
          puStack_4 = (uint *)CONCAT22(puStack_4._2_2_,in_ES);
          bVar5 = in(uVar20);
...
code_r0x00402e0a:
  ...
  *pbVar9 = *pbVar9 + (char)pbVar9;
  ...
  pbVar28 = pbVar29;
code_r0x00402e19:
  if (bVar3 == 0 || bVar32 != (char)bVar3 < '\0') goto code_r0x00402e36;
...
code_r0x00402e81:
  ...
  *(byte *)unaff_EDI = (byte)*unaff_EDI + (byte)param_1;
  bVar21 = *pbVar29;
  *pbVar29 = *pbVar29 + bVar3;
  *(byte **)(pbVar13 + -0x73) = pbVar28 + (uint)CARRY1(bVar21,bVar3) + *(int *)(pbVar13 + -0x73);
  *pbVar29 = *pbVar29 + bVar3;
...
code_r0x00402f16:
      ...
      while( true ) {
        ...
        *pbVar6 = *pbVar6 + cVar23;
        param_1 = (byte *)CONCAT22((short)((uint)param_1 >> 0x10),
                                   CONCAT11((char)((uint)param_1 >> 8) + *pbVar6,cVar23 - *pbVar6));
        *(byte *)puVar11 = (byte)*puVar11 + (char)puVar11;
code_r0x00402f3b:
        cVar23 = (char)pbVar6;
        ...
        *(byte *)puVar11 = (byte)*puVar11 + cVar4;
        cVar19 = ((bVar18 - (char)iVar15) - CARRY1(bVar21,bVar18) | bVar3 | bVar5) + (byte)*puVar11;
        ...
        *pbVar6 = *pbVar6 + bVar17;
        if (CARRY1(bVar21,bVar17)) {
          ...
          *pbVar6 = *pbVar6 + bVar17;
          ...
          cVar26 = bVar21 + *(char *)(CONCAT31((int3)(CONCAT22(uVar27,CONCAT11(bVar21,cVar26)) >> 8)
                                               ,cVar4) + 0x1e);
          ...
          *(char *)CONCAT31(uVar14,bVar21) = *(char *)CONCAT31(uVar14,bVar21) + bVar21;
          pcVar7 = (char *)CONCAT31(uVar14,bVar21 + 0x2a);
          pcVar24 = (char *)CONCAT22(uVar27,CONCAT11(cVar26 + *(char *)(CONCAT22(uVar27,CONCAT11(
                                                  cVar26,cVar4)) + 0x26),cVar4));
          *pcVar7 = *pcVar7 + bVar21 + 0x2a;
          bVar21 = bVar21 + 0x54 & *pbVar6;
          *(char *)CONCAT31(uVar14,bVar21) = *(char *)CONCAT31(uVar14,bVar21) + bVar21;
          cVar4 = bVar21 + 0x2a;
          ...
          if ((POPCOUNT(cVar4) & 1U) == 0) {
            ...
            *pbVar13 = *pbVar13 + bVar5;
            ...
            if (!CARRY1(bVar21,bVar5)) {
              ...
              if (SCARRY1(bVar5,*pcVar24) != (char)(bVar5 + *pcVar24) < '\0') goto code_r0x00403072;
