 ...
 * Prototype   : pointer get_SettingsList(undefined4 param_1, byte * param_2)
 * Local Vars  : pcStackY_a4, pbStackY_6c, puStackY_58, puStackY_54, uStackY_50, uStack_28, uStack_24, uStack_21, uStack_20, uStack_18, puStack_4, param_1, uVar1, param_2, pcVar2, uVar3, uVar4, uVar5, bVar6, bVar7, cVar8, bVar9, bVar10, cVar11, cVar12, in_EAX, pcVar13, iVar14, puVar15, pbVar16, uVar17, pcVar18, iVar19, pbVar20, pbVar21, uVar22, uVar23, puVar24, piVar25, pcVar26, piVar27, puVar28, uVar29, uVar30, iVar31, uVar32, extraout_ECX, extraout_ECX_00, extraout_ECX_01, extraout_ECX_02, uVar33, bVar34, cVar35, uVar36, uVar37, bVar38, uVar39, pbVar40, puVar41, puVar42, pbVar43, puVar44, uVar45, unaff_EBX, pbVar46, cVar47, unaff_EBP, puVar48, puVar49, unaff_EDI, pbVar50, puVar51, in_ES, uVar52, uVar53, in_CS, uVar54, in_SS, uVar55, in_DS, in_GS_OFFSET, bVar56, in_AF, bVar57, in_TF, in_IF, bVar58, bVar59, in_NT, uVar60, in_stack_ffffffc8, in_stack_ffffffd0
 */
...
undefined * __fastcall get_SettingsList(undefined4 param_1,byte *param_2)

{
  ...
  *pcVar18 = *pcVar18 + bVar10;
  bVar7 = ((byte)((uint)param_1 >> 8) | bVar6) + bVar7 | *pbVar40;
    ...
    *pcVar13 = *pcVar13 + cVar11;
    ...
    if ((POPCOUNT(bVar9) & 1U) == 0) {
      ...
      *piVar27 = (*piVar27 - (int)piVar27) - (uint)(0xd7 < bVar9);
      bVar9 = *pbVar40;
      *pbVar40 = *pbVar40 + bVar38;
      out(*puStack_4,(short)pbVar40);
      cVar11 = ((cVar11 + '*') - (char)*piVar27) - CARRY1(bVar9,bVar38);
      piVar27 = (int *)CONCAT31(uVar29,cVar11);
      *pbVar40 = *pbVar40 + bVar38;
      bVar9 = cVar47 - *(byte *)((int)puStack_4 + 0x1f);
      ...
      *(char *)piVar27 = (char)*piVar27 + cVar11;
      ...
      puStack_4 = (uint *)((int)puStack_4 + (4 - *piVar27));
      ...
      *pcVar18 = *pcVar18 + (char)pcVar18;
      ...
      iVar14 = (CONCAT31((int3)((uint)pcVar18 >> 8),(char)pcVar18 + '\x02') + -0xa0a0000) -
               (uint)bVar56;
      bVar7 = (byte)iVar14;
      bVar56 = CARRY1(bVar7,(byte)*puStack_4);
      uVar29 = (undefined3)((uint)iVar14 >> 8);
      cVar47 = bVar7 + (byte)*puStack_4;
...
code_r0x00402188:
  ...
  *pbVar16 = (*pbVar16 - bVar10) - CARRY1(bVar7,bVar10);
  bVar56 = CARRY1((byte)*puStack_4,bVar10);
  uVar17 = *puStack_4;
  *(byte *)puStack_4 = (byte)*puStack_4 + bVar10;
...
code_r0x004021be:
      ...
      pbVar46 = (byte *)((int)puStack_4 + (int)pbVar50 * 2);
...
code_r0x004021f1:
    *(byte *)puStack_4 = (byte)*puStack_4 + (char)pbVar16;
  }
  else {
    if ((byte)*puStack_4 != 0 && SCARRY1((byte)uVar17,bVar10) == (char)(byte)*puStack_4 < '\0') {
      *pbVar16 = *pbVar16 + bVar10;
      puVar15 = (uint *)CONCAT31(uVar29,cVar47 + -0x55);
      puStack_4[(int)pbVar50 * 2] =
           (uint)(pbVar40 + (uint)(0xd2 < bVar10) + puStack_4[(int)pbVar50 * 2]);
      goto code_r0x004021be;
    }
code_r0x004021d4:
    if (bVar56) {
...
code_r0x0040220c:
  ...
  *(byte *)puStack_4 = (byte)*puStack_4 - cVar8;
  *pcVar18 = *pcVar18 + (char)pcVar18;
  cVar8 = cVar8 - *pcVar18;
  ...
  *(byte *)puVar41 = (byte)*puVar41 + cVar8;
  ...
  cVar47 = (char)pbVar20 - *(byte *)((int)puStack_4 + 2);
  ...
  if ((POPCOUNT(cVar47) & 1U) == 0) {
    *pbVar40 = *pbVar40 + bVar7;
    ...
    if (bVar7 == 0) {
      ...
      *(byte *)piVar27 = (char)*piVar27 + bVar7;
      ...
      puVar48 = (uint *)((int)puStack_4 + *piVar27);
    ...
    *(byte *)puVar41 = (byte)*puVar41 + cVar8;
    pbVar40 = (byte *)CONCAT31(uVar30,bVar7 | (byte)*puStack_4);
  }
  ...
  *pbVar40 = *pbVar40 + (byte)pbVar40;
  ...
  if ((POPCOUNT(bVar6) & 1U) == 0) {
    ...
    *(byte *)puStack_4 = (byte)*puStack_4 + 1;
                          ...
                          *pbVar46 = *pbVar46 + cVar12;
                          ...
                          if (SCARRY1(bVar6,cVar12) != (char)*pbVar46 < '\0') {
                            ...
                            *pcVar18 = *pcVar18 + cVar8;
                            ...
                            uVar32 = (undefined1)uStack_20;
                            cVar47 = (char)((uint)uStack_20 >> 8) + *(char *)(uStack_20 + 0xf);
                            *pcVar18 = *pcVar18 + cVar8;
                            ...
                            *(char *)CONCAT31(uVar29,bVar6) =
                            ...
                            pcVar18 = (char *)CONCAT31(uVar29,bVar6 + 0x2a);
                            cVar47 = cVar47 + *(char *)(CONCAT22(uStack_20._2_2_,
                            ...
                            *(char *)CONCAT31(uVar29,bVar6) =
                            ...
                            puVar42 = (uint *)CONCAT22(uStack_20._2_2_,
                                                  ...
                                                  uStack_20._2_2_,CONCAT11(cVar47,uVar32)) + 0x11),
                                                  uVar32));
                            *pcVar18 = *pcVar18 + bVar6 + 0x2a;
                            bVar6 = bVar6 + 0x54 & *pbVar16;
...
code_r0x0040309a:
          ...
          *(byte *)(puVar44 + 0x828000) = (byte)puVar44[0x828000] - cVar11;
          *pcVar18 = *pcVar18 + cVar47;
          cVar12 = (char)pcStackY_a4 - (byte)*puVar44;
          pcVar13 = (char *)CONCAT22((short)((uint)pcStackY_a4 >> 0x10),
