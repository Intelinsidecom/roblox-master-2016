 ...
 * ============================================================
 * Address     : 0040305d
 * Raw Name    : set_InputFormat
 * Demangled   : set_InputFormat
 * Prototype   : void set_InputFormat(undefined4 value, byte * param_2)
 * Local Vars  : cVar1, bVar2, cVar3, in_EAX, pcVar4, pbVar5, piVar6, param_2, uVar7, bVar8, cVar9, cVar10, unaff_EBX, unaff_ESI, pbVar11, in_ES, unaff_retaddr, uVar12, value
 */
...
void __fastcall set_InputFormat(undefined4 value,byte *param_2)

{
  ...
  pcVar4 = (char *)CONCAT31(uVar7,cVar1);
  ...
  bVar8 = (char)((uint)value >> 8) + *pcVar4;
  cVar9 = (char)param_2;
  ...
  *(char *)CONCAT31(uVar7,bVar2) = *(char *)CONCAT31(uVar7,bVar2) + bVar2;
  ...
  pcVar4 = (char *)CONCAT22((short)((uint)value >> 0x10),CONCAT11(bVar8 + *pbVar5,(char)value));
