 ...
 * ============================================================
 * Address     : 00402ffe
 * Raw Name    : set_NameFilter
 * Demangled   : set_NameFilter
 * Prototype   : void set_NameFilter(undefined4 value, byte * param_2)
 * Local Vars  : pcStack_14, cVar1, bVar2, bVar3, cVar4, in_EAX, pcVar5, pbVar6, piVar7, uVar8, value, bVar9, cVar10, unaff_EBX, cVar11, uVar12, unaff_EBP, unaff_ESI, in_ES, in_DS, param_2
 */
...
void __fastcall set_NameFilter(undefined4 value,byte *param_2)
