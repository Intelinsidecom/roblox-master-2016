 ...
 * Raw Name    : Main
 * Demangled   : Main
 * Prototype   : byte * Main(int * args, byte * param_2)
 * Local Vars  : param_2, cVar2, iVar1, bVar4, cVar3, in_EAX, bVar5, uVar7, piVar6, pbVar9, pcVar8, pbVar11, puVar10, uVar13, pbVar12, args, cVar15, bVar14, uVar17, uVar16, unaff_EBP, unaff_EBX, pbVar18, unaff_ESI, unaff_EDI, pbVar19, in_CF, in_ES, bVar20, in_AF, unaff_retaddr, bVar21
 */
...
/* WARNING: Removing unreachable block (ram,0x0040457e) */
...
byte * __fastcall Main(int *args,byte *param_2)

{
  ...
  while( true ) {
    *(byte **)in_EAX = in_EAX + *(int *)in_EAX;
    pbVar9 = (byte *)((uint)in_EAX | 0x1027309);
    bVar4 = *param_2;
    bVar5 = (byte)args;
    bVar14 = *param_2;
    *param_2 = *param_2 + bVar5;
    if (SCARRY1(bVar14,bVar5) != (char)*param_2 < '\0') break;
    if (CARRY1(bVar4,bVar5)) {
      do {
        *pbVar9 = *pbVar9 + (byte)pbVar9;
        ...
        bVar4 = *pbVar9;
        bVar14 = (byte)((uint)args >> 8);
        cVar3 = (char)args;
        cVar15 = bVar14 + *pbVar9;
        args = (int *)CONCAT22((short)((uint)args >> 0x10),CONCAT11(cVar15,cVar3));
        iVar1 = *(int *)pbVar9;
        *param_2 = *param_2 + cVar3;
        param_2 = (byte *)CONCAT22((short)((uint)param_2 >> 0x10),
                                   CONCAT11((char)((uint)param_2 >> 8) - *unaff_ESI,(char)param_2));
        pbVar9 = pbVar9 + *(int *)param_2 + (uint)CARRY1(bVar14,bVar4) + iVar1;
        if ((POPCOUNT((uint)pbVar9 & 0xff) & 1U) == 0) goto code_r0x00404439;
        *unaff_ESI = *unaff_ESI + (byte)pbVar9;
        unaff_EBX[-0x21f60000] = unaff_EBX[-0x21f60000] - cVar15;
        uVar13 = (undefined3)((uint)pbVar9 >> 8);
        cVar2 = ((byte)pbVar9 | *unaff_ESI) - 6;
        ...
        *(char *)piVar6 = (char)*piVar6 + cVar2;
        bVar4 = cVar2 + (char)*piVar6;
        in_AF = 9 < (bVar4 & 0xf) | in_AF;
        uVar7 = CONCAT31(uVar13,bVar4 + in_AF * '\x06') & 0xffffff0f;
        bVar14 = (byte)uVar7;
        cVar15 = (char)((uint)pbVar9 >> 8) + in_AF;
        pbVar9 = (byte *)CONCAT22((short)(uVar7 >> 0x10),CONCAT11(cVar15,bVar14));
...
code_r0x00404439:
    ...
    *args = (int)(pcVar8 + *args);
    *param_2 = *param_2 + (char)args;
    bVar14 = cVar3 - *pcVar8;
    in_EAX = (byte *)CONCAT31(uVar13,bVar14);
    *unaff_EBX = *unaff_EBX + (char)param_2;
    *unaff_EBX = *unaff_EBX ^ bVar14;
    unaff_EBX[0x26000000] = unaff_EBX[0x26000000] + (char)((uint)args >> 8);
    bVar4 = *in_EAX;
    *in_EAX = *in_EAX + bVar14;
    *(byte **)(unaff_EBX + 0xb) = unaff_ESI + (uint)CARRY1(bVar4,bVar14) + *(int *)(unaff_EBX + 0xb)
    ;
  }
  *pbVar9 = *pbVar9 + (char)pbVar9;
  *unaff_ESI = *unaff_ESI + 1;
  puVar10 = (uint *)(CONCAT31((int3)((uint)pbVar9 >> 8),(char)pbVar9 + '\t') | 1);
  bVar4 = *unaff_ESI;
  bVar14 = (byte)puVar10;
  *unaff_ESI = *unaff_ESI + bVar14;
  ...
  else if (!CARRY1(bVar4,bVar14)) goto code_r0x00404473;
  *puVar10 = *puVar10 + (int)puVar10;
  args = (int *)CONCAT31((int3)((uint)args >> 8),bVar5 | *param_2);
code_r0x00404473:
  uVar16 = (undefined2)((uint)args >> 0x10);
  cVar15 = (char)args;
  bVar14 = (char)((uint)args >> 8) + (char)*puVar10;
  uVar7 = *puVar10;
  *unaff_EBX = *unaff_EBX + bVar14;
  pbVar9 = (byte *)((uint)puVar10 & uVar7 | *unaff_EDI);
  out(*(undefined4 *)unaff_ESI,(short)param_2);
  *(byte **)pbVar9 = pbVar9 + *(int *)pbVar9;
  bVar14 = bVar14 | *pbVar9;
  *unaff_EBX = *unaff_EBX + bVar14;
  uVar13 = (undefined3)((uint)pbVar9 >> 8);
  ...
  *pbVar11 = *pbVar11 + 0x59;
  bVar14 = bVar14 | *pbVar11;
  pbVar12 = (byte *)CONCAT22(uVar16,CONCAT11(bVar14,cVar15));
  ...
  *param_2 = *param_2 + cVar15;
  pcVar8 = (char *)CONCAT22((short)((uint)pbVar9 >> 0x10),
                            CONCAT11((char)((uint)pbVar9 >> 8) - (char)unaff_EBX,bVar4));
  *pcVar8 = *pcVar8 + bVar4;
  cVar3 = (bVar4 | 8) - 2;
  ...
  *(char *)piVar6 = (char)*piVar6 + cVar3;
  pbVar9 = unaff_ESI + (uint)bVar21 * -8 + 0xc;
  out(*(undefined4 *)(unaff_ESI + 8),uVar17);
  *pcVar8 = *pcVar8 + cVar15;
  out(*(undefined4 *)pbVar9,uVar17);
  *pcVar8 = *pcVar8 + cVar15;
  pbVar12 = (byte *)((uint)pcVar8 & 0xffffff00);
  bVar14 = bVar14 | pbVar12[CONCAT22(uVar16,CONCAT11(bVar14,cVar15))];
  pbVar11 = (byte *)CONCAT22(uVar16,CONCAT11(bVar14,cVar15));
  pbVar18 = pbVar9 + (uint)bVar21 * -8 + 4 + (uint)bVar21 * -8 + 4;
  out(*(undefined4 *)(pbVar9 + (uint)bVar21 * -8 + 4),(short)pbVar12);
  bVar4 = *pbVar11;
  ...
  *pbVar12 = *pbVar12 + cVar15;
  ...
  if (*pbVar12 != 0) {
    *(byte *)puVar10 = (byte)*puVar10 + bVar4;
    pbVar11 = (byte *)CONCAT22(uVar16,CONCAT11(bVar14 + (byte)*puVar10,cVar15));
    *pbVar18 = *pbVar18;
    pbVar9 = pbVar18 + (uint)bVar21 * -8 + 4;
  ...
  *pbVar12 = *pbVar12 + (char)pbVar11;
  ...
  do {
    ...
    *pbVar12 = *pbVar12 ^ (byte)puVar10;
    pbVar18 = pbVar12;
code_r0x004044ff:
    cVar3 = (char)((uint)pbVar11 >> 8);
    *pbVar18 = *pbVar18 + cVar3;
    uVar7 = *puVar10;
    bVar4 = (byte)puVar10;
    *(byte *)puVar10 = (byte)*puVar10 + bVar4;
    bVar14 = 9 < (bVar4 & 0xf) | bVar20;
    uVar13 = (undefined3)((uint)puVar10 >> 8);
    bVar5 = bVar4 + bVar14 * '\x06';
    bVar5 = bVar5 + (0x90 < (bVar5 & 0xf0) | CARRY1((byte)uVar7,bVar4) | bVar14 * (0xf9 < bVar5)) *
                    '`';
    ...
    *pbVar12 = *pbVar12 + bVar5;
    ...
    pbVar11 = (byte *)CONCAT22((short)((uint)pbVar11 >> 0x10),
                               CONCAT11(cVar3 + *(byte *)((int)unaff_EDI + 0x3e),(char)pbVar11));
    *(char *)CONCAT31(uVar13,bVar5) = *(char *)CONCAT31(uVar13,bVar5) + bVar5;
    bVar14 = 9 < (bVar5 & 0xf) | bVar14;
    bVar5 = bVar5 + bVar14 * -6;
    bVar4 = 0x9f < bVar5 | bVar14 * (bVar5 < 6);
    ...
    *puVar10 = *puVar10 | (uint)puVar10;
    pbVar19 = pbVar9 + (uint)bVar21 * -8 + 4;
    while( true ) {
      bVar21 = (in_ES & 0x400) != 0;
      bVar20 = (in_ES & 0x10) != 0;
      ...
      *puVar10 = (uint)(*puVar10 + (int)puVar10);
      ...
      pbVar9 = pbVar19 + (uint)bVar21 * -8 + 4;
      ...
      *unaff_EBP = *unaff_EBP - cVar15;
      *pbVar12 = *pbVar12 + cVar3;
      bVar4 = bVar14 - 0x17;
      cVar15 = cVar15 + *(byte *)((int)unaff_EDI + 0x46);
      pbVar11 = (byte *)CONCAT22((short)((uint)pbVar11 >> 0x10),CONCAT11(cVar15,cVar3));
      *(char *)CONCAT31(uVar13,bVar4) = *(char *)CONCAT31(uVar13,bVar4) + bVar4;
      *unaff_EBP = *unaff_EBP - cVar15;
      *pbVar12 = *pbVar12 + cVar3;
      bVar14 = bVar14 - 0x21;
      puVar10 = (uint *)CONCAT31(uVar13,bVar14);
      if (bVar4 < 10) break;
      *puVar10 = *puVar10 | (uint)puVar10;
      *(byte *)puVar10 = (byte)*puVar10 + bVar14;
      ...
      bVar14 = bVar14 | (byte)*puVar10;
      *(char *)CONCAT31(uVar13,bVar14) = *(char *)CONCAT31(uVar13,bVar14) + bVar14;
      puVar10 = (uint *)CONCAT31(uVar13,bVar14 | *pbVar18);
      pbVar19 = pbVar9;
    }
  } while( true );
}
