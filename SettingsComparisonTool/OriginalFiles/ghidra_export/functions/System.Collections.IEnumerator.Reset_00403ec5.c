 ...
 * Prototype   : void System.Collections.IEnumerator.Reset(char * param_1, uint * param_2, undefined4 param_3, char * param_4)
 * Local Vars  : bVar2, puVar1, cVar4, cVar3, pbVar5, in_EAX, pcVar7, puVar6, uVar9, pcVar8, puVar11, piVar10, bVar13, uVar12, iVar15, param_1, param_2, uVar14, param_3, uVar17, param_4, pcVar16, cVar19, uVar18, unaff_EBX, uVar20, cVar22, bVar21, uVar24, cVar23, iVar25, unaff_EBP, unaff_ESI, iVar26, unaff_EDI, puVar27, in_CF, piVar28, bVar30, bVar29, unaff_retaddr
 */
...
void __fastcall
System_Collections_IEnumerator_Reset(char *param_1,uint *param_2,undefined4 param_3,char *param_4)

{
  ...
  while (!(bool)in_CF) {
    bVar2 = (byte)unaff_EBX;
    unaff_EBX = CONCAT31((int3)((uint)unaff_EBX >> 8),bVar2 - (char)*param_2);
    in_CF = bVar2 < (byte)*param_2;
  }
  do {
    *in_EAX = *in_EAX + (char)in_EAX;
    uVar20 = (undefined2)((uint)unaff_EBX >> 0x10);
    bVar13 = (byte)unaff_EBX;
    bVar21 = (byte)((uint)unaff_EBX >> 8) | (byte)*param_2;
    unaff_ESI = (uint *)((int)unaff_ESI - *(int *)in_EAX);
    bVar2 = (char)in_EAX + *in_EAX;
    in_EAX = (byte *)CONCAT31((int3)((uint)in_EAX >> 8),bVar2);
    *in_EAX = *in_EAX + bVar2;
    *in_EAX = *in_EAX & bVar2;
    *param_1 = *param_1 + (char)param_2;
    cVar22 = bVar21 + *(char *)(CONCAT22(uVar20,CONCAT11(bVar21,bVar13)) + -0x26);
    iVar15 = CONCAT22(uVar20,CONCAT11(cVar22,bVar13));
    do {
      *in_EAX = *in_EAX + (char)in_EAX;
      ...
      *pbVar5 = *pbVar5 + cVar3;
      ...
      if (bVar29) {
        ...
        *pcVar8 = *pcVar8 + cVar4;
        puVar6 = (uint *)CONCAT31((int3)(CONCAT22(uVar20,CONCAT11(cVar22 + cVar19,bVar13)) >> 8),
...
code_r0x00404092:
    ...
    *(byte *)unaff_ESI = (byte)*unaff_ESI + bVar13;
    unaff_EBX = CONCAT22(uVar20,CONCAT11(cVar22 + *(char *)(iVar15 + -10),bVar13));
    *in_EAX = *in_EAX + cVar3;
    param_1 = (char *)CONCAT22((short)((uint)param_4 >> 0x10),
    ...
    param_2._0_2_ = CONCAT11(param_2._1_1_ - *(char *)(unaff_EBX + -4),(char)param_2);
